...
export default function Banner1({ defaultStyle = {}, defaultClassName = "",  fade = true }) {
  return (
    <AtomSlider7>
      {data.map((item, index) => (
        <div key={index} className="bg-yellow-700 h-screen">
          <div className="relative w-full h-full">
              ...
              <div className={`px-4 md:px-10 lg:px-24 absolute w-full flex flex-col justify-center h-full inset-0`}>
                {item.title && (
                  <h1
