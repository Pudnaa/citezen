...
const WeeklyFooterInto = () => {
  ...
  // console.log("FooterV readyDatasrc", readyDatasrc);
  // console.log("FooterV widgetnemgooReady", widgetnemgooReady);
    ...
    <div className="2xl:mx-auto 2xl:container xl:px-20 lg:px-12 px-10 py-12">
      <div className="sm:flex items-start justify-between">
        ...
        <div className="sm:ml-12 sm:mt-0 mt-20 flex gap-x-28 md:gap-x-20 lg:gap-x-28 gap-y-20 flex-wrap items-start">
          <div className="flex flex-col space-y-6 items-start">
            <h1 className="text-xl font-semibold leading-5 text-gray-800">
              ABOUT US
            </h1>
            <p className="hover:text-gray-500 text-base leading-4 cursor-pointer text-gray-800">
              Store Locator
            </p>
            <p className="hover:text-gray-500 text-base leading-4 cursor-pointer text-gray-800">
              Gift cards
          ...
          <div className="md:hidden flex flex-col space-y-6 items-start">
            <h1 className="text-xl font-semibold leading-5 text-gray-800 uppercase">
              Visit Us
            </h1>
            <p className="hover:text-gray-500 text-base leading-4 cursor-pointer text-gray-800">
              Mayfair
          ...
          <div className="lg:block hidden">
            ...
            <div className="flex flex-col space-y-6 mt-12">
              <p className="text-xl font-semibold leading-5 text-gray-800 uppercase">
                Location
              </p>
            ...
            <div className="flex flex-col space-y-6 mt-12">
              ...
              <p className="hover:text-gray-500 text-sm leading-4 cursor-pointer text-gray-800">
                Sign Up
              </p>
            </div>
          </div>
      ...
      <div className="lg:hidden sm:flex items-center justify-between md:mt-20">
        ...
        <div className="flex flex-col md:mt-0 mt-20 space-y-6">
          ...
          <p className="text-sm leading-4 cursor-pointer text-gray-800">
            Sign Up
          </p>
        </div>
      </div>
