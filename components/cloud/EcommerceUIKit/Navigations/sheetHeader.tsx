...
export default function sheetHeader() {
  ...
  //console.log("sheetHeader readyDatasrc", readyDatasrc);
  // console.log("NavigationII widgetnemgooReady", widgetnemgooReady);
            ...
            <div className="hidden md:block">
              <ul className="flex items-center space-x-6">
                <li>
                  <a
                    href="javascript:void(0)"
                    className="dark:text-white text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"
                  >
                    {" "}
                    New{" "}
                  </a>
