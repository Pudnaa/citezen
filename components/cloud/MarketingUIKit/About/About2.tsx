...
export default function About2() {
  ...
  // console.log("About2 config", config);
  // console.log("About2 readyDatasrc", readyDatasrc);
  // console.log("About2 widgetnemgooReady", widgetnemgooReady);
  // console.log("About2 positionConfig", positionConfig);
  return (
    <div>
