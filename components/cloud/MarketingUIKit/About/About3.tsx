...
export default function About3() {
  ...
  // console.log("About3 config", config);
  // console.log("About3 readyDatasrc", readyDatasrc);
  // console.log("About3 widgetnemgooReady", widgetnemgooReady);
  // console.log("About3 positionConfig", positionConfig);
  return (
    <div>
