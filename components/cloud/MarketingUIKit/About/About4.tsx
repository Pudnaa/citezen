...
export default function About4() {
  ...
  // console.log("About4 config", config);
  // console.log("About4 readyDatasrc", readyDatasrc);
  // console.log("About4 widgetnemgooReady", widgetnemgooReady);
  // console.log("About4 positionConfig", positionConfig);
  return (
    <>
      <div className="2xl:mx-auto 2xl:container xl:px-20 md:px-6 p-4 py-12 lg:flex items-stretch  justify-between">
