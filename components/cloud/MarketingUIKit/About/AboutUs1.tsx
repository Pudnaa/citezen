...
const AboutUs1 = () => {
  ...
  // console.log("AboutUs1 config", config);
  // console.log("AboutUs1 readyDatasrc", readyDatasrc);
  // console.log("AboutUs1 widgetnemgooReady", widgetnemgooReady);
  // console.log("AboutUs1 positionConfig", positionConfig);
  return (
