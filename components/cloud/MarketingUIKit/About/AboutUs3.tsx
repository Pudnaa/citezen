...
const AboutUs3 = () => {
  ...
  // console.log("AboutUs3 config", config);
  // console.log("AboutUs3 readyDatasrc", readyDatasrc);
  // console.log("AboutUs3 widgetnemgooReady", widgetnemgooReady);
  // console.log("AboutUs3 positionConfig", positionConfig);
  return (
