...
const AboutUs5 = () => {
  ...
  // console.log("AboutUs5 config", config);
  // console.log("AboutUs5 readyDatasrc", readyDatasrc);
  // console.log("AboutUs5 widgetnemgooReady", widgetnemgooReady);
  // console.log("AboutUs5 positionConfig", positionConfig);
  return (
