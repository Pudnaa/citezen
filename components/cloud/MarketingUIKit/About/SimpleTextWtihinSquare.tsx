...
export default function SimpleTextWtihinSquare() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("SimpleTextWtihinSquare config", config);
  // console.log("SimpleTextWtihinSquare readyDatasrc", readyDatasrc);
  // console.log("SimpleTextWtihinSquare widgetnemgooReady", widgetnemgooReady);
  // console.log("SimpleTextWtihinSquare positionConfig", positionConfig);
  return (
    <>
