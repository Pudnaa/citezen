...
export default function UserInformationWithRightAlignedMap() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("UserInformationWithRightAlignedMap config", config);
  // console.log("UserInformationWithRightAlignedMap readyDatasrc", readyDatasrc);
  // console.log("UserInformationWithRightAlignedMap widgetnemgooReady", widgetnemgooReady);
  // console.log("UserInformationWithRightAlignedMap positionConfig", positionConfig);
  return (
    <>
      <div className="mx-auto container">
          ...
          <div className="lg:flex justify-between">
            <div className="pl-5 py-5">
              ...
              <div className="flex items-center py-5">
                <img
                  src="https://cdn.tuk.dev/assets/templates/classified/12.png"
            ...
            <div className="lg:w-60 lg:mt-0 mt-4">
              <img
                src="https://cdn.tuk.dev/assets/templates/classified/map.png"
        ...
        <div className="my-4 max-w-6xl bg-gray-100 p-5">
          ...
          <p className="text-xs leading-snug text-gray-600 py-3 lg:pr-32">
            Duis congue mattis odio, a posuere urna feugiat id. Praesent id est
            tellus. Sed mollis ex at dapibus hendrerit. Curabitur efficitur
            nulla at finibus suscipit. Duis efficitur lobortis diam vitae
            egestas.
            <br />
            <br />
            Duis congue mattis odio, a posuere urna feugiat id. Praesent id est
