...
export default function Blog3() {
  ...
  // console.log("Blog3 config", config);
  // console.log("Blog3 readyDatasrc", readyDatasrc);
  // console.log("Blog3 widgetnemgooReady", widgetnemgooReady);
  // console.log("Blog3 positionConfig", positionConfig);
          ...
          <div className="flex lg:flex-col sm:flex-row flex-col items-start lg:gap-0 gap-6 lg:w-96 w-auto">
            ...
            <div className="lg:mt-10">
              ...
              <div className="mt-6 flex items-center cursor-pointer">
                ...
                {/* <RenderAtom 
                  item={{value:"fal fa-car"}}
                  defaultAtom="icon"
                  customClassName="w-10 h-8"
                /> */}
                <svg
                  width={16}
                  height={10}
