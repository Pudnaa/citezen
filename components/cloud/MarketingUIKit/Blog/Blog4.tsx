...
export default function Blog4() {
  ...
  // console.log("Blog4 config", config);
  // console.log("Blog4 readyDatasrc", readyDatasrc);
  // console.log("Blog4 widgetnemgooReady", widgetnemgooReady);
  // console.log("Blog4 positionConfig", positionConfig);
  return (
    <>
