...
function BlogLarge() {
  ...
  // console.log("BlogLarge config", config);
  // console.log("BlogLarge readyDatasrc", readyDatasrc);
  // console.log("BlogLarge widgetnemgooReady", widgetnemgooReady);
  // console.log("BlogLarge positionConfig", positionConfig);
  return (
    <div className="py-16 sm:py-24 md:py-44 lg:py-20 px-4">
      <div>
        ...
        <p className="text-xl text-gray-600 text-center xl:w-3/5 mx-auto w-11/12">
          ...
          great for your readers.” As a blogger, everything you do flows from
          understanding your audience and seeking to help them.
        </p>
      </div>
        ...
        <div className="xl:w-1/3 sm:w-5/12 sm:max-w-xs relative pb-16 lg:pb-10 xl:max-w-sm  lg:w-1/2 w-11/12 mx-auto sm:mx-0">
          ...
          <div className="p-6 shadow-lg w-11/12 mx-auto -mt-20 bg-white rounded z-20 relative">
            ...
            <p className="text-lg text-gray-800 text-center pb-3">
              The way I drive and handle a car, is an expression of my inner
              feeling.
            </p>
