    ...
    <div className="container mx-auto lg:w-11/12 pt-16">
      <div className="mb-12 xl:w-full lg:w-full w-11/12 mx-auto">
        ...
        <p className="text-xl text-gray-600 xl:w-7/12 mx-auto xl:mx-0">
          Content: Selling to people through social media is like going to a
          party, meeting somebody for the first time, and then saying, “Hey, do
      ...
      <div className="lg:flex md:flex sm:flex xl:justify-around flex-wrap md:justify-around sm:justify-around lg:justify-around">
        <div className="xl:mb-0 mb-8 lg:w-1/4 xl:w-1/4 w-11/12 mx-auto xl:mx-0 sm:w-2/5 md:w-5/12 sm:mx-auto xl:pr-4 lg:pl-0 lg:pr-4 xl:pl-0">
          <div className="h-48 bg-cover rounded">
            <img
              src="https://cdn.tuk.dev/assets/photo-1557804506-669a67965ba0.jfif"
          ...
          <div className="px-4 pt-4 pb-5 bg-white border-b border-gray-300">
            <p className="uppercase text-sm text-indigo-700 pb-3 text-center">
              LEADERSHIP
            </p>
            <p className="text-center text-xl font-semibold pb-4">
              How To Build Diverse Networks That Last
            </p>
        ...
        <div className="xl:mb-0 mb-8 lg:w-1/4 xl:w-1/4 w-11/12 mx-auto xl:mx-0 sm:w-2/5 md:w-5/12 sm:mx-auto xl:pr-4 lg:pl-4 lg:pr-0">
          <div className="h-48 bg-cover rounded">
            <img
              src="https://cdn.tuk.dev/assets/photo-1547306843-f8fea4d65f9b.jfif"
              className="h-full w-full object-cover overflow-hidden rounded shadow"
            />
          </div>
          <div className="px-4 pt-4 pb-5 bg-white border-b border-gray-300">
        ...
        <div className="xl:mb-0 mb-8 lg:w-1/4 xl:w-1/4 w-11/12 mx-auto xl:mx-0 sm:w-2/5 md:w-5/12 sm:mx-auto xl:pr-4 lg:pl-4 lg:pr-0">
          <div className="h-48 bg-cover rounded">
            <img
              src="https://cdn.tuk.dev/assets/photo-1559125148-869baf508c95.jfif"
              className="h-full w-full object-cover overflow-hidden rounded shadow"
            />
          </div>
          <div className="px-4 pt-4 pb-5 bg-white border-b border-gray-300">
        ...
        <div className="xl:mb-0 mb-8 lg:w-1/4 xl:w-1/4 w-11/12 mx-auto xl:mx-0 sm:w-2/5 md:w-5/12 sm:mx-auto xl:pr-4 lg:pl-4 lg:pr-0">
          <div className="h-48 bg-cover rounded">
            <img
              src="https://cdn.tuk.dev/assets/photo-1513759565286-20e9c5fad06b.jfif"
              className="h-full w-full object-cover overflow-hidden rounded shadow"
            />
          </div>
          <div className="px-4 pt-4 pb-5 bg-white border-b border-gray-300">
