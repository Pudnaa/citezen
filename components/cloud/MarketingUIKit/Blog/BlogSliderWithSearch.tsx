...
function BlogSliderWithSearch() {
  ...
  // console.log("BlogSliderWithSearch config", config);
  // console.log("BlogSliderWithSearch readyDatasrc", readyDatasrc);
  // console.log("BlogSliderWithSearch widgetnemgooReady", widgetnemgooReady);
  // console.log("BlogSliderWithSearch positionConfig", positionConfig);
  return (
    <div className="container py-10 mx-auto pt-16">
      <div className="mb-12 xl:w-full w-11/12 mx-auto">
        ...
        <p className="text-xl text-gray-600 xl:w-7/12 mx-auto xl:mx-0">
          If you love writing or making music or blogging or any sort of
          performing art, then do it. Do it with everything you’ve got. Just
          don’t plan on using it as a shortcut to making a living.
        </p>
      </div>
      <div className="xl:flex lg:flex md:flex xl:w-full mx-auto xl:mx-0 w-11/12 flex-wrap mb-32 justify-between">
        <div className="xl:w-9/12 lg:w-2/3 md:w-2/3 relative bg-center bg-cover bg-no-repeat h-64">
          <img
            src="https://tuk-cdn.s3.amazonaws.com/assets/components/blog/b_4.png"
            className="h-full w-full object-cover overflow-hidden absolute rounded shadow"
          />
            ...
            <div className="w-full bg-white shadow rounded-tr-md rounded-b-md">
              <div className="py-4 px-6">
                ...
                <p className="text-base text-gray-600">
                  Placing effectiveness over efficiency should be your daily
                  mantra. You can never complete everything, yet you can finish
                  the tasks.
                </p>
              </div>
          ...
          <div className="border-gray-400 border h-full xl:h-64 lg:h-64 md:h-64 overflow-y-auto rounded-lg">
            <div className="flex items-center bg-gray-100 px-3 rounded-lg mt-5 mx-4 mb-5">
              ...
              <input
                ...
                className="text-gray-500 text-sm bg-transparent focus:outline-none py-3 w-full"
              />
            </div>
            <div className="mx-5">
              <div className="cursor-pointer mb-4">
                <p className="text-sm text-indigo-700 pb-1 uppercase">
                  Business
                </p>
...
export default BlogSliderWithSearch;
