		...
		<>
			<div className="container mx-auto ">
				<div className="mb-12 xl:w-full w-11/12 mx-auto">
					<h1 className="xl:text-2xl pt-4 xl:pt-0 text-citizen-title xl:text-left font-semibold mb-2 text-xl">
						Шинэ мэдээ
					</h1>
				</div>
				<div className="">
					<div className="w-100 flex sm:mx-auto mb-2 items-center">
						...
						<div className="w-2/3 pt-3 pb-3 pl-5 pr-5">
							<p className="text-base text-gray-800 mb-0 cursor-pointer">
