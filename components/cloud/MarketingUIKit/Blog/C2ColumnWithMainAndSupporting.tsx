...
function C2ColumnWithMainAndSupporting() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("C2ColumnWithMainAndSupporting config", config);
  // console.log("C2ColumnWithMainAndSupporting readyDatasrc", readyDatasrc);
  // console.log("C2ColumnWithMainAndSupporting widgetnemgooReady", widgetnemgooReady);
  // console.log("C2ColumnWithMainAndSupporting positionConfig", positionConfig);
  return (
    <>
...
export default C2ColumnWithMainAndSupporting;
