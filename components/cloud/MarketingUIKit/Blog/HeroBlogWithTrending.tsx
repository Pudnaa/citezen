...
function HeroBlogWithTrending() {
  ...
  // console.log("HeroBlogWithTrending config", config);
  // console.log("HeroBlogWithTrending readyDatasrc", readyDatasrc);
  // console.log("HeroBlogWithTrending widgetnemgooReady", widgetnemgooReady);
  // console.log("HeroBlogWithTrending positionConfig", positionConfig);
  return (
    <div className="container mx-auto pt-16">
      <div className="mb-12 xl:w-full w-11/12 mx-auto">
        ...
        <p className="text-xl text-gray-600 xl:w-7/12 mx-auto xl:mx-0">
          Blogging has turned the publishing world on its head. It allows you to
          write and publish anything, from anywhere, and have it be immediately
          available to billions of people all around the world.
        </p>
      </div>
        ...
        <div className="absolute bottom-0 w-11/12 ml-2 xl:mx-0 lg:mx-0 xl:w-6/12 lg:w-6/12 xl:ml-12 lg:ml-12 rounded-md lg:-mb-56 sm:-mb-48 -mb-64 xl:-mb-24">
          <div className="w-full py-5 px-6 bg-white shadow rounded">
            ...
            <p className="text-base text-gray-600">
              Drop the 9-to-5 Schedule. It's no longer news that the traditional
              9-to-5 workday is not the optimal productivity time span.
            </p>
...
export default HeroBlogWithTrending;
