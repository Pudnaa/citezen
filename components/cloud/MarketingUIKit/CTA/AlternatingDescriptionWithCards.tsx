...
function AlternatingDescriptionWithCards() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("AlternatingDescriptionWithCards config", config);
  // console.log("AlternatingDescriptionWithCards readyDatasrc", readyDatasrc);
  // console.log("AlternatingDescriptionWithCards widgetnemgooReady", widgetnemgooReady);
  // console.log("AlternatingDescriptionWithCards positionConfig", positionConfig);
  return (
    <>
...
export default AlternatingDescriptionWithCards;
