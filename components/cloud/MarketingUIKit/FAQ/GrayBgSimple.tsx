...
function GrayBgSimple() {
  ...
  // console.log("GrayBgSimple config", config);
  // console.log("GrayBgSimple readyDatasrc", readyDatasrc);
  // console.log("GrayBgSimple widgetnemgooReady", widgetnemgooReady);
  // console.log("GrayBgSimple positionConfig", positionConfig);
  return (
    <div className="pt-16">
            ...
            <li className="py-6 border-gray-200 border-solid border-b">
              <div className="flex justify-between items-center">
                ...
                <div
                  className="cursor-pointer"
                  onClick={() =>
                    question === 2 ? setquestion(15) : setquestion(2)
                  }
                >
                  {question === 2 ? (
                    <svg
            ...
            <li className="py-6 border-gray-200 border-solid border-b">
              <div className="flex justify-between items-center">
                ...
                <div
                  className="cursor-pointer"
                  onClick={() =>
                    question === 3 ? setquestion(15) : setquestion(3)
                  }
                >
                  {question === 3 ? (
                    <svg
            ...
            <li className="py-6 border-gray-200 border-solid border-b">
              <div className="flex justify-between items-center">
                ...
                <div
                  className="cursor-pointer"
                  onClick={() =>
                    question === 4 ? setquestion(15) : setquestion(4)
                  }
                >
                  {question === 4 ? (
                    <svg
