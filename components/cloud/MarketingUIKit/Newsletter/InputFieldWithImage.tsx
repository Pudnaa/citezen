...
function InputFieldWithImage() {
  ...
  // console.log("InputFieldWithImage config", config);
  // console.log("InputFieldWithImage readyDatasrc", readyDatasrc);
  // console.log("InputFieldWithImage widgetnemgooReady", widgetnemgooReady);
  // console.log("InputFieldWithImage positionConfig", positionConfig);
  return (
