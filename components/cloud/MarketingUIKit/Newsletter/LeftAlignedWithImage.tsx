...
function LeftAlignedWithImage() {
  ...
  // console.log("LeftAlignedWithImage config", config);
  // console.log("LeftAlignedWithImage readyDatasrc", readyDatasrc);
  // console.log("LeftAlignedWithImage widgetnemgooReady", widgetnemgooReady);
  // console.log("LeftAlignedWithImage positionConfig", positionConfig);
  return (
    <div className="pt-16">
        ...
        <div className="xl:flex lg:flex md:flex flex-wrap items-center container mx-auto px-6">
          <div className="md:w-1/2 w-full rounded-r-lg">
            <img
              ...
              className="h-full w-full object-cover rounded-r shadow"
            />
          </div>
          <div className="xl:w-5/12 lg:w-5/12 md:w-5/12 xl:pl-10 lg:pl-10 w-full xl:mx-0 lg:mx-0 mx-auto">
            ...
            <p className="text-xl mb-8 text-gray-600 leading-7">
              Join and get to know about exciting offers, our latest products
...
export default LeftAlignedWithImage;
