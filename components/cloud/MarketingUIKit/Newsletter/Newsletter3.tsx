...
export default function Newsletter3() {
  ...
  // console.log("Newsletter3 config", config);
  // console.log("Newsletter3 readyDatasrc", readyDatasrc);
  // console.log("Newsletter3 widgetnemgooReady", widgetnemgooReady);
  // console.log("Newsletter3 positionConfig", positionConfig);
