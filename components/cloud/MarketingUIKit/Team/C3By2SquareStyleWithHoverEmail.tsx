...
export default function C3By2SquareStyleWithHoverEmail() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("C3By2SquareStyleWithHoverEmail config", config);
  // console.log("C3By2SquareStyleWithHoverEmail readyDatasrc", readyDatasrc);
  // console.log("C3By2SquareStyleWithHoverEmail widgetnemgooReady", widgetnemgooReady);
  // console.log("C3By2SquareStyleWithHoverEmail positionConfig", positionConfig);
  return (
    <>
          ...
          <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            <div className="flex w-full justify-center xl:justify-end">
              <div className="flex flex-col items-center">
                <div className="pt-4 px-5 border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black  lg:w-96">
                  <div className="relative w-full">
                    <img
                      src="https://cdn.tuk.dev/assets/templates/radian/team(1).png"
                      alt="oliver"
                      className="w-full"
                    />
                ...
                <h4 className="text-2xl text-gray-800 font-semibold mt-2">
                  Oliver Queen
                </h4>
                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                  ...
                  <h5 className="text-gray-800 text-lg mt-2 font-medium">
                    Founder, CEO
                  </h5>
                </div>
              </div>
            ...
            <div className="flex w-full justify-center xl:justify-end">
              <div className="flex flex-col items-center">
                ...
                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                  ...
                  <h5 className="text-gray-800 text-lg mt-2 font-medium tracking-wider">
                    Senior Architect
                  </h5>
                  <h6 className="mt-2 text-indigo2 text-sm tracking-wider">
                    exmaple@mail.com
                  </h6>
                </div>
              </div>
            ...
            <div className="flex w-full justify-center xl:justify-end">
              <div className="flex flex-col items-center">
                <div className="pt-4 px-5 border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black  lg:w-96">
                  <div className="relative w-full">
                    <img
                      src="https://cdn.tuk.dev/assets/templates/radian/team(3).png"
                      className="w-full"
                      alt="John"
                    />
                    <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
            ...
            <div className="flex w-full justify-center xl:justify-end">
              <div className="flex flex-col items-center">
                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black  lg:w-96">
                  <div className="relative w-full">
                    <img
                      src="https://cdn.tuk.dev/assets/templates/radian/team(4).png"
                      className="w-full"
                      alt="Dinah"
                    />
                    <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
            ...
            <div className="flex w-full justify-center xl:justify-end">
              <div className="flex flex-col items-center">
                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black  lg:w-96">
                  <div className="relative w-full">
                    <img
                      src="https://cdn.tuk.dev/assets/templates/radian/team(5).png"
                      className="w-full"
                      alt="sarah"
                    />
                    <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
            ...
            <div className="flex w-full justify-center xl:justify-end">
              <div className="flex flex-col items-center">
                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black  lg:w-96">
                  <div className="relative w-full">
                    <img
                      src="https://cdn.tuk.dev/assets/templates/radian/team(6).png"
                      className="w-full"
                      alt="Halena"
                    />
                    <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
