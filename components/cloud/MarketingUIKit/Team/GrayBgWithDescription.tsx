...
function GrayBgWithDescription() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("GrayBgWithDescription config", config);
  // console.log("GrayBgWithDescription readyDatasrc", readyDatasrc);
  // console.log("GrayBgWithDescription widgetnemgooReady", widgetnemgooReady);
  // console.log("GrayBgWithDescription positionConfig", positionConfig);
  return (
    <div>
...
export default GrayBgWithDescription;
