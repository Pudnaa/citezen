...
export default function Team2() {
  ...
  // console.log("Team2 config", config);
  // console.log("Team2 readyDatasrc", readyDatasrc);
  // console.log("Team2 widgetnemgooReady", widgetnemgooReady);
  // console.log("Team2 positionConfig", positionConfig);
  return (
    <>
