...
export default function Team3() {
  ...
  // console.log("Team3 config", config);
  // console.log("Team3 readyDatasrc", readyDatasrc);
  // console.log("Team3 widgetnemgooReady", widgetnemgooReady);
  // console.log("Team3 positionConfig", positionConfig);
  return (
    <div>
