...
function WhiteBgWithDescription() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("WhiteBgWithDescription config", config);
  // console.log("WhiteBgWithDescription readyDatasrc", readyDatasrc);
  // console.log("WhiteBgWithDescription widgetnemgooReady", widgetnemgooReady);
  // console.log("WhiteBgWithDescription positionConfig", positionConfig);
  return (
    <div>
...
export default WhiteBgWithDescription;
