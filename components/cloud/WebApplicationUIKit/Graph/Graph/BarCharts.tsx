...
export default function BarCharts() {
  ...
  // console.log("BarCharts config", config);
  // console.log("BarCharts readyDatasrc", readyDatasrc);
  // console.log("BarCharts widgetnemgooReady", widgetnemgooReady);
  // console.log("BarCharts positionConfig", positionConfig);
                          ...
                          <tr>
                            ...
                            <td>
                              <div className="w-full h-full">
                                <div className="w-12 h-12 flex rounded-full justify-center items-center cursor-pointer bg-indigo-500">
