...
function C8ColListingCardWithStatsAndFilters() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("C8ColListingCardWithStatsAndFilters config", config);
  // console.log("C8ColListingCardWithStatsAndFilters readyDatasrc", readyDatasrc);
  // console.log("C8ColListingCardWithStatsAndFilters widgetnemgooReady", widgetnemgooReady);
  // console.log("C8ColListingCardWithStatsAndFilters positionConfig", positionConfig);
  return (
    <>
...
export default C8ColListingCardWithStatsAndFilters;
