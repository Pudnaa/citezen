...
function C8ColListingWithSearchAndFilter() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("C8ColListingWithSearchAndFilter config", config);
  // console.log("C8ColListingWithSearchAndFilter readyDatasrc", readyDatasrc);
  // console.log("C8ColListingWithSearchAndFilter widgetnemgooReady", widgetnemgooReady);
  // console.log("C8ColListingWithSearchAndFilter positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="flex w-full">
          <div className="w-full">
            <div className="border border-gray-400 dark:border-gray-200 relative flex items-center rounded mt-6">
              ...
              <input
                type="text"
                placeholder="Marketing Candidates"
                className="focus:outline-none pl-10 w-full py-3 text-sm"
                id="Search"
                aria-label="Search"
              />
        ...
        <div className="pt-8 pb-8 border-b border-gray-300 xl:flex lg:flex md:flex sm:flex relative">
          <div className="flex w-11/12">
            <div className="h-12 w-12 rounded-full bg-center bg-cover bg-no-repeat">
              <img
                className="w-full object-cover rounded-full border-2 border-white shadow"
                src="https://tuk-cdn.s3.amazonaws.com/assets/components/grid_cards/gc_19.png"
              />
            </div>
        ...
        <div className="pt-6 pb-8 border-b border-gray-300 xl:flex lg:flex md:flex sm:flex relative">
          <div className="flex w-11/12">
            <div className="h-12 w-12 rounded-full bg-center bg-cover bg-no-repeat">
              <img
                className="w-full object-cover rounded-full border-2 border-white shadow"
                src="https://tuk-cdn.s3.amazonaws.com/assets/components/grid_cards/gc_20.png"
              />
            </div>
            <div className="w-full ml-3">
              <p className="text-base text-gray-800 dark:text-gray-100 font-bold">
        ...
        <div className="pt-6 pb-8 border-b border-gray-300 xl:flex lg:flex md:flex sm:flex relative">
          <div className="flex w-11/12">
            <div className="h-12 w-12 rounded-full bg-center bg-cover bg-no-repeat">
              <img
                className="w-full object-cover rounded-full border-2 border-white shadow"
                src="https://tuk-cdn.s3.amazonaws.com/assets/components/grid_cards/gc_21.png"
              />
            </div>
            <div className="w-full ml-3">
              <p className="text-base text-gray-800 dark:text-gray-100 font-bold">
        ...
        <div className="pt-6 pb-8 xl:flex lg:flex md:flex sm:flex relative">
          <div className="flex w-11/12">
            <div className="h-12 w-12 rounded-full bg-center bg-cover bg-no-repeat">
              <img
                className="w-full object-cover rounded-full border-2 border-white shadow"
                src="https://tuk-cdn.s3.amazonaws.com/assets/components/grid_cards/gc_22.png"
              />
            </div>
            <div className="w-full ml-3">
              <p className="text-base text-gray-800 dark:text-gray-100 font-bold">
...
export default C8ColListingWithSearchAndFilter;
