...
function C8ColUserProfileCard() {
  ...
  // console.log("C8ColUserProfileCard config", config);
  // console.log("C8ColUserProfileCard readyDatasrc", readyDatasrc);
  // console.log("C8ColUserProfileCard widgetnemgooReady", widgetnemgooReady);
  // console.log("C8ColUserProfileCard positionConfig", positionConfig);
  return (
    <>
...
export default C8ColUserProfileCard;
