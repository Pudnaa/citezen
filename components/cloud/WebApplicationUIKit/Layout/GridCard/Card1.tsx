...
export default function Card1() {
  ...
  // console.log("Card1 config", config);
  // console.log("Card1 readyDatasrc", readyDatasrc);
  // console.log("Card1 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card1 positionConfig", positionConfig);
  return (
    <>
