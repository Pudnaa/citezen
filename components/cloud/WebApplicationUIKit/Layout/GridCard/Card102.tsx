...
const Card102 = () => {
  ...
  // console.log("Card102 config", config);
  // console.log("Card102 readyDatasrc", readyDatasrc);
  // console.log("Card102 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card102 positionConfig", positionConfig);
  return (
    <>
      <div className="max-w-sm w-full relative rounded shadow bg-white dark:bg-gray-800">
        <div className="py-6 px-6">
          <p className="sm:text-lg text-xl font-bold leading-5 text-gray-800 dark:text-gray-100">
            Lorem ipsum dolor
          </p>
          <p className="sm:text-sm text-xs leading-loose text-gray-500 dark:text-gray-400 mt-6">
            30 mins ago
          </p>
        ...
        <div className="py-6 mt-4 border-t-2 border-gray-200 dark:border-gray-800">
          <div className="flex items-center px-6">
            ...
            />
            <div className="pl-4">
              <p className="sm:text-lg text-base font-semibold leading-4 text-indigo-700">
                Tolu Arowoselu
              </p>
              <p className="text-sm leading-4 text-gray-500 dark:text-gray-400 mt-1">
                On human rights
              </p>
            </div>
          </div>
