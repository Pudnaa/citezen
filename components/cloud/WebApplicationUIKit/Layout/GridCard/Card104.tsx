...
const Card104 = () => {
  ...
  // console.log("Card104 config", config);
  // console.log("Card104 readyDatasrc", readyDatasrc);
  // console.log("Card104 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card104 positionConfig", positionConfig);
  return (
    <>
