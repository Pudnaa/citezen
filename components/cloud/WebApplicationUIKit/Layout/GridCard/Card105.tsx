...
const Card105 = () => {
  ...
  // console.log("Card105 config", config);
  // console.log("Card105 readyDatasrc", readyDatasrc);
  // console.log("Card105 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card105 positionConfig", positionConfig);
  return (
    <>
      <div className="max-w-sm py-6 relative rounded shadow bg-white dark:bg-gray-800">
        ...
        <div className="border-t-2 px-6 pt-14 sm:mt-3 mt-8 border-gray-200 dark:border-gray-800">
          ...
          <p className="sm:text-sm text-xs leading-5 text-gray-500 dark:text-gray-400 pt-2">
            We are looking to hire a freelance UI/UX designer with at least 2
            years of experience in delivering top quality web and mobile
            designs.
          </p>
        </div>
      </div>
