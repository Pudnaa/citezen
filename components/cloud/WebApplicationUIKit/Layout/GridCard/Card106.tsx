...
const Card106 = () => {
  ...
  // console.log("Card106 config", config);
  // console.log("Card106 readyDatasrc", readyDatasrc);
  // console.log("Card106 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card106 positionConfig", positionConfig);
  return (
    <>
      <div className="max-w-sm p-6 rounded shadow bg-white dark:bg-gray-800">
        ...
        <p className="text-lg font-bold leading-5 text-gray-800 dark:text-gray-100 mt-3">
          Product Designer
        </p>
        <p className="text-base leading-5 text-gray-500 dark:text-gray-400 mt-3">
          We are looking to hire a freelance UI/UX designer fluent in the use of
          Figma and invision studio.
        </p>
        <div>
        ...
        <div className="mt-6 flex items-center">
          <div className="flex items-center">
            <img
              ...
              src="https://i.ibb.co/bbWSx2p/1.png"
              alt="dp"
            />
            <img
              className="-ml-2 w-6 h-6 rounded-full"
              src="https://i.ibb.co/QY635bP/2.png"
              alt="dp"
            />
            <img
              className="-ml-2 w-6 h-6 rounded-full"
              src="https://i.ibb.co/F0y6TTT/3.png"
              alt="dp"
            />
            <div className="w-6 h-6 -ml-2 bg-white border-2 border-gray-200 dark:border-gray-100 dark:bg-gray-800 flex items-center justify-center rounded-full">
              <p className="text-sm font-semibold leading-4 text-gray-500 dark:text-gray-100">
                +2
              </p>
            </div>
          </div>
          <p className="ml-2 text-xs leading-4 text-gray-500 dark:text-gray-400 sm:ml-5">
            5+ have applied
          </p>
        </div>
        <div className="flex items-center justify-between mt-6">
          ...
          <button className="flex items-center sm:px-10 px-6 py-3 bg-gray-100 hover:bg-gray-200 rounded ml-6 sm:ml-14">
            <p className="text-sm font-semibold leading-4 text-center text-indigo-700">
              Message
            </p>
          </button>
        </div>
