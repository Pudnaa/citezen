...
const Card107 = () => {
  ...
  // console.log("Card107 config", config);
  // console.log("Card107 readyDatasrc", readyDatasrc);
  // console.log("Card107 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card107 positionConfig", positionConfig);
  return (
    <>
      <div className="flex justify-center">
        <div className="max-w-sm rounded shadow bg-white dark:bg-gray-800">
          <div>
              ...
              <div className="sm:flex items-center">
                ...
                <div className="sm:ml-5 ml-3">
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <p className="sm:text-base text-sm text-gray-500 dark:text-gray-400 ml-2">
                      Singapore
                    </p>
                  </div>
                </div>
            ...
            <p className="text-base md:text-lg px-6 font-bold text-gray-800 dark:text-gray-100 ">
              Product Designer
            </p>
            <p className="text-sm md:text-base px-6 leading-5 text-gray-500 dark:text-gray-400 mt-2 md:mt-3">
              We are looking to hire a freelance UI/UX designer fluent in the
              use of Figma and invision studio.
            </p>
          </div>
