...
const Card109 = () => {
  ...
  // console.log("Card109 config", config);
  // console.log("Card109 readyDatasrc", readyDatasrc);
  // console.log("Card109 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card109 positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="max-w-sm rounded shadow bg-white dark:bg-gray-800">
          <div className="p-4 md:p-6">
            <div className="flex items-center">
              <img
                src="https://i.ibb.co/Wxb9VYc/DP.png"
                alt="dp"
            ...
            <div className="sm:mt-7 mt-4">
              ...
              <p className="sm:text-base text-sm leading-5 text-gray-500 dark:text-gray-400 mt-2">
                I'm an experienced Skilled Webflow, WordPress, User Experience,
                User Interface and Graphics designer with a demonstrated history
