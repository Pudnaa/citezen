...
const Card113 = () => {
  ...
  // console.log("Card113 config", config);
  // console.log("Card113 readyDatasrc", readyDatasrc);
  // console.log("Card113 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card113 positionConfig", positionConfig);
  return (
    <div>
      <div className="flex justify-center py-12 w-full px-4 overflow-y-hidden">
        <div className="w-96 relative rounded overflow-y-hidden mt-8 md:mt-0">
          <a href="javascript:void(0)">
            <img
              className="w-full"
              src="https://cdn.tuk.dev/assets/templates/upcoming/virtual%20event%20management.png"
            />
          </a>
          <div className="relative z-10 bg-white dark:bg-gray-900 border dark:border-gray-700 rounded-lg -mt-16 p-4 md:p-6 w-11/12 mx-auto">
            <div className="flex items-center justify-between w-full">
              <a
                className="text-sm md:text-xl  text-gray-900 dark:text-gray-50 min-h-56 font-extrabold"
                href="javascript:void(0)"
              >
                Eventex - Events Webapp
              </a>
            </div>
            <p className="mt-3 text-xs md:text-base font-light leading-none text-gray-700 dark:text-gray-400">
            ...
            <div className="mt-4 flex items-center">
              ...
              >
                <path
                  d="M8.03756 0L0 2.656L1.22019 12.504L7.99582 16L14.7798 12.504L16 2.656L8.03756 0Z"
                  fill="#9CA3AF"
                />
                <path
                  d="M7.9953 0V1.776V1.768V9.872V16L14.7237 12.504L15.9346 2.656L7.9953 0Z"
                  fill="#9CA3AF"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M3.13007 12.4443L8.00118 1.77759L12.8556 12.4443H11.0394L10.0601 10.0575H5.92552L4.94627 12.4443H3.13007ZM8.00207 5.24297L6.57909 8.58601H9.42504L8.00207 5.24297Z"
                  fill="#E5E7EB"
                />
              </svg>
              <svg
              ...
              >
                <path
                  d="M11.0785 0.348927L9 4.3384L6.92155 0.348927H0L9.00037 17.625L18 0.348927L11.0785 0.348927Z"
                  fill="#9CA3AF"
                />
                <path
                  d="M11.0793 -2.28882e-05L9.00081 4.35172L6.92227 -2.28882e-05H3.60059L9.00081 11.306L14.401 -2.28882e-05H11.0793Z"
                  fill="#E5E7EB"
                />
              </svg>
            </div>
            <div className="mt-7 w-full justify-end flex">
              <div className="flex items-stretch">
                <button className="focus:outline-none py-2 px-6 border rounded border-gray-700 text-sm md:text-base md:font-medium text-gray-700 dark:text-gray-300 mr-3 leading-4 hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-800 dark:focus:bg-gray-800">
                  Preview
                </button>
                <a id="eventex-events-webapp" href="javascript:void(0)">
                  <button className="text-white focus:outline-none bg-gradient-to-r from-red-500 to-pink-500 rounded-md py-2 px-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="flex justify-center py-12 w-full px-4 overflow-y-hidden">
        <div className="w-96 relative rounded overflow-y-hidden mt-8 md:mt-0">
          ...
          <div className="relative z-10 bg-white dark:bg-gray-900 border dark:border-gray-700 rounded-lg -mt-16 p-4 md:p-6 w-11/12 mx-auto">
            <div className="flex items-center justify-between w-full">
              <a
                className="text-sm lg:text-xl  text-gray-900 dark:text-gray-50 min-h-56 font-extrabold"
                href="javascript:void(0)"
              >
                Eventex - Events Webapp
              </a>
