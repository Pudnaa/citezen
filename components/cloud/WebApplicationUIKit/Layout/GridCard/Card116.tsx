...
const Card116 = () => {
  ...
  // console.log("Card116 config", config);
  // console.log("Card116 readyDatasrc", readyDatasrc);
  // console.log("Card116 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card116 positionConfig", positionConfig);
  return (
    <div className="py-8">
