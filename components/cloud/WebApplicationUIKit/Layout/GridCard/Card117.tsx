...
export default function Card117() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card117 config", config);
  // console.log("Card117 readyDatasrc", readyDatasrc);
  // console.log("Card117 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card117 positionConfig", positionConfig);
  // useEffect(() => {
