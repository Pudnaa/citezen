...
export default function Card118() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card118 config", config);
  // console.log("Card118 readyDatasrc", readyDatasrc);
  // console.log("Card118 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card118 positionConfig", positionConfig);
  return (
    <>
      <div className="py-8 flex items-center justify-center px-4">
        <div className="max-w-lg sm:w-auto w-full  p-4 bg-white border border-gray-200 sm:flex items-center">
          <div className="sm:w-80 flex flex-col shrink-0">
          ...
          <div className="sm:w-20 sm:ml-7 sm:mt-0 mt-4 sm:block flex  items-center  justify-between">
            <div className="border-l-2 border-indigo-700 pl-4">
              ...
              <p className="text-sm font-semibold mt-1 leading-none text-green-700">
                +15%
              </p>
            </div>
            <div className="border-l-2 sm:mt-8 border-indigo-700 pl-4">
              <h2 className="text-sm leading-none text-gray-600">Canada</h2>
              <p className="text-sm mt-1 font-semibold leading-none text-red-600">
                -09%
              </p>
            </div>
            <div className="border-l-2 sm:mt-8 border-indigo-700 pl-4">
