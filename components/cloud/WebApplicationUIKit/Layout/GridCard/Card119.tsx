...
export default function Card119() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card119 config", config);
  // console.log("Card119 readyDatasrc", readyDatasrc);
  // console.log("Card119 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card119 positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="max-w-6xl w-full bg-white shadow">
          <div className="border-b border-gray-200 p-4">
            ...
            <div className="mt-3 sm:flex items-center justify-between">
              ...
              <p className="text-sm leading-none text-gray-600 sm:mt-0 mt-4">
