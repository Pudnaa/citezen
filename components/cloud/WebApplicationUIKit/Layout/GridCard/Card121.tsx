...
export default function Card121() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card121 config", config);
  // console.log("Card121 readyDatasrc", readyDatasrc);
  // console.log("Card121 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card121 positionConfig", positionConfig);
  // useEffect(() => {
