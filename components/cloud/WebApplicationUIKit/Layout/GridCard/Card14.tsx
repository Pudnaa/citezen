...
export default function Card14() {
  ...
  // console.log("Card14 config", config);
  // console.log("Card14 readyDatasrc", readyDatasrc);
  // console.log("Card14 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card14 positionConfig", positionConfig);
  return (
    <>
