...
export default function Card18() {
  ...
  // console.log("Card18 config", config);
  // console.log("Card18 readyDatasrc", readyDatasrc);
  // console.log("Card18 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card18 positionConfig", positionConfig);
  return (
    <>
