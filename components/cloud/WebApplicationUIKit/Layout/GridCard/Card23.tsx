...
export default function Card23() {
  ...
  // console.log("Card23 config", config);
  // console.log("Card23 readyDatasrc", readyDatasrc);
  // console.log("Card23 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card23 positionConfig", positionConfig);
  // useEffect(() => {
