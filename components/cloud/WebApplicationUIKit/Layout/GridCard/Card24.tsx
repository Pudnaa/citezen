...
export default function Card24() {
  ...
  // console.log("Card24 config", config);
  // console.log("Card24 readyDatasrc", readyDatasrc);
  // console.log("Card24 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card24 positionConfig", positionConfig);
  // useEffect(() => {
