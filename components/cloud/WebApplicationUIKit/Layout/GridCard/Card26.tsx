...
export default function Card26() {
  ...
  // console.log("Card26 config", config);
  // console.log("Card26 readyDatasrc", readyDatasrc);
  // console.log("Card26 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card26 positionConfig", positionConfig);
  // useEffect(() => {
