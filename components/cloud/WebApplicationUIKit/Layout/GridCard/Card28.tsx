...
export default function Card28() {
  ...
  // console.log("Card28 config", config);
  // console.log("Card28 readyDatasrc", readyDatasrc);
  // console.log("Card28 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card28 positionConfig", positionConfig);
  // useEffect(() => {
  //     var config = {
  //         type: "doughnut",
  //         data: {
