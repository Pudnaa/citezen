...
export default function Card3() {
  ...
  // console.log("Card3 config", config);
  // console.log("Card3 readyDatasrc", readyDatasrc);
  // console.log("Card3 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card3 positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="md:w-96 rounded-md shadow-lg p-5 dark:bg-gray-800 bg-white">
          ...
          <div className="flex items-center justify-between pt-5">
            <div className="flex items-center">
              ...
              <p className="text-gray-600 dark:text-gray-100 text-sm font-medium pl-3">
                New message from{" "}
                <span className="text-blue-500">@Kelly190</span>
              </p>
            </div>
          </div>
          <div className="flex items-center justify-between pt-5">
