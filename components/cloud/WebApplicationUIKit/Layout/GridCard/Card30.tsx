...
export default function Card30() {
  ...
  // console.log("Card30 config", config);
  // console.log("Card30 readyDatasrc", readyDatasrc);
  // console.log("Card30 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card30 positionConfig", positionConfig);
  return (
    <>
