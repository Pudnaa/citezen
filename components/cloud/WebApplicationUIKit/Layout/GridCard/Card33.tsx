...
export default function Card33() {
  ...
  // console.log("Card33 config", config);
  // console.log("Card33 readyDatasrc", readyDatasrc);
  // console.log("Card33 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card33 positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="max-w-7xl py-6 px-8  bg-white dark:bg-gray-800">
          <div className="sm:flex items-center justify-between">
            <div className=" sm:mb-0 mb-4 flex items-center">
              ...
              />
              <p className="text-xl pl-4 font-semibold leading-5 text-gray-800 dark:text-gray-100">
                Antonin Hafer
              </p>
            </div>
            <p className="text-xs font-medium leading-3 text-gray-800 dark:text-gray-400">
            ...
            <div className="sm:block flex w-full items-center">
              ...
              <div className="flex flex-col sm:hidden items-center justify-between h-64 pl-5">
                <div className="flex flex-col items-start">
                  ...
                  <p className="text-xs leading-3 pt-2.5 text-gray-500 dark:text-gray-400">
                    May 14, 2019 - 8:25 AM
                  </p>
                </div>
                <div className="flex flex-col items-start">
          ...
          <div className="pt-4 px-12 sm:block hidden">
            <div className="flex items-center justify-between">
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs leading-4 pt-2.5 text-gray-500 dark:text-gray-400">
                  May 14, 2019 - 8:25&nbsp;AM
                </p>
              </div>
