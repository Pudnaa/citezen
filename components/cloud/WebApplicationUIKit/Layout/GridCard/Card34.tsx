...
export default function Card34() {
  ...
  // console.log("Card34 config", config);
  // console.log("Card34 readyDatasrc", readyDatasrc);
  // console.log("Card34 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card34 positionConfig", positionConfig);
  return (
    <>
      <div className="flex items-center justify-center w-full h-full py-8 px-4">
        <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded">
          <div className="py-6 px-8">
            <p className="text-xl font-semibold leading-5 text-gray-800 dark:text-gray-100">
              Orders
            </p>
            <input
              type="search"
              className="bg-gray-200 py-3 rounded-full w-full mt-4 focus:outline-none px-4 text-xs font-medium leading-3 text-gray-500"
          ...
          <div className="py-5 px-8">
            <div className="border rounded-3xl py-4 px-5 border-gray-400 dark:border-gray-200">
              ...
              <div className="sm:flex  items-end justify-between pt-4">
                <div className="flex sm:mb-0 mb-4 items-center">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1512054502232-10a0a035d672?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
                  />
                  <img
                    alt="iphone"
                    className="w-8 h-8 rounded mr-2 object-cover object-center"
                    src="https://images.unsplash.com/photo-1530319067432-f2a729c03db5?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1960&q=80"
                  />
                  <img
                    alt="iphone"
                    className="w-8 h-8 rounded mr-2 object-cover object-center"
                    src="https://images.unsplash.com/photo-1556656793-08538906a9f8?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1950&q=80"
                  />
                </div>
                <p className="text-xs font-semibold leading-3 text-green-600">
                  Delivered
                </p>
              </div>
              ...
              <div className="sm:flex  items-center justify-between pt-8">
                <p className="text-xs sm:mb-0 mb-4 font-medium leading-3 text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-center">
                  <div className="pr-4 cursor-pointer">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M11.4521 15.225C12.0945 16.4364 13.2986 17.4081 14.6795 17.4081H16.1234L18.5251 19.8083V17.1976C20.3907 17.128 22.1543 15.2961 22.1543 13.044C22.1543 10.7487 20.4977 8.93884 18.44 8.93884"
                        stroke="#14B2BD"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                  ...
                  <div className="cursor-pointer">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M9.63354 15L3.75569 18.0902L4.87826 11.5451L0.12298 6.90983L6.69462 5.95492L9.63354 0L12.5725 5.95492L19.1441 6.90983L14.3888 11.5451L15.5114 18.0902L9.63354 15Z"
                        fill="#EAB308"
                      />
                    </svg>
                  </div>
              ...
              <div className="pt-5 flex items-center">
                ...
                <p className="text-xs pl-4 leading-3 text-gray-500 dark:text-gray-400">
            ...
            <div className="border rounded-3xl py-4 px-5 mt-5 border-gray-400 dark:border-gray-200">
              ...
              <div className="sm:flex  items-end justify-between pt-4">
                ...
                <p className="text-xs font-semibold leading-3 text-blue-600">
                  Ready to Ship
                </p>
              </div>
              <div className="mt-6 sm:flex items-center justify-between">
