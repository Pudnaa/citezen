...
export default function Card38() {
  ...
  // console.log("Card38 config", config);
  // console.log("Card38 readyDatasrc", readyDatasrc);
  // console.log("Card38 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card38 positionConfig", positionConfig);
  return (
    <>
      <div className="flex items-center justify-center w-full h-full py-8 px-4">
        <div className="max-w-sm bg-white dark:bg-gray-800 rounded py-6">
          <p className="text-xl px-8 text-gray-800 dark:text-gray-100 font-semibold leading-5">
            Support Chat
          </p>
          <div className="sm:flex items-center justify-between pt-6 py-6 px-8">
            <div className="flex">
              ...
              <div className="w-10 h-10 border-2 rounded-full border-indigo-700 ml-5 relative">
                ...
                <div className="flex items-center justify-center absolute top-0 -ml-1 -mt-1 w-3.5 h-3.5 bg-indigo-700 rounded-full">
                  <p className="text-xs font-semibold leading-3 text-white">
                    5
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-end sm:mt-0 mt-4">
              <p className="text-xs font-semibold leading-3 text-indigo-700 ml-5">
                view all
              </p>
              <svg
                className="ml-1"
          ...
          <div className="px-4 pt-8 sm:pt-0">
            <div className="w-full h-12 border rounded-lg border-gray-400 dark:border-gray-200 border-opacity-50 flex items-center justify-between">
              <div>
                <input
                  className="focus:outline-none px-5 w-full text-xs leading-3 bg-transparent text-gray-500"
                  placeholder="Reply..."
                />
              </div>
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-4 text-gray-500 dark:text-dark-400 cursor-pointer icon icon-tabler icon-tabler-paperclip"
                  width={24}
                  height={24}
                  viewBox="0 0 24 24"
                  strokeWidth={2}
