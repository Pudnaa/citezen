...
export default function Card43() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card43 config", config);
  // console.log("Card43 readyDatasrc", readyDatasrc);
  // console.log("Card43 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card43 positionConfig", positionConfig);
  // useEffect(() => {
