...
export default function Card44() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card44 config", config);
  // console.log("Card44 readyDatasrc", readyDatasrc);
  // console.log("Card44 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card44 positionConfig", positionConfig);
  // useEffect(() => {
