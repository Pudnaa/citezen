...
export default function Card45() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card45 config", config);
  // console.log("Card45 readyDatasrc", readyDatasrc);
  // console.log("Card45 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card45 positionConfig", positionConfig);
  return (
    <>
