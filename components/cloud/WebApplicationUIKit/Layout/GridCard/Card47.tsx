...
export default function Card47() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card47 config", config);
  // console.log("Card47 readyDatasrc", readyDatasrc);
  // console.log("Card47 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card47 positionConfig", positionConfig);
  return (
    <>
