...
export default function Card5() {
  ...
  // console.log("Card5 config", config);
  // console.log("Card5 readyDatasrc", readyDatasrc);
  // console.log("Card5 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card5 positionConfig", positionConfig);
  return (
    <>
      <div className="flex items-center justify-center py-8 px-4">
        <div className="md:w-96 rounded shadow-lg p-5 bg-white w-full dark:bg-gray-800">
          <h1 className="text-lg font-bold leading-7 text-gray-800 dark:text-gray-100">
            Progress
          </h1>
          <div className="flex items-end justify-between pt-7">
            <div className="flex flex-col">
              <h1 className="text-base font-medium leading-4 text-gray-800 dark:text-gray-100">
                All Invoices
              </h1>
              <p className="pt-1 text-xs leading-3 dark:text-gray-400 text-gray-600">
                Monthly Analysis
              </p>
            </div>
            <div>
              <p className="text-base font-semibold leading-4 text-indigo-700">
                $6,390
              </p>
            </div>
          </div>
          ...
          <div className="flex items-end justify-between pt-6">
            ...
            <div>
              <p className="text-base font-semibold leading-4 text-green-500">
                $6,320
              </p>
            </div>
          </div>
          ...
          <div className="flex items-end justify-between pt-6">
            ...
            <div>
              <p className="text-base font-semibold leading-4 text-pink-500">
                $6,320
              </p>
            </div>
          </div>
