...
export default function Card50() {
  ...
  // console.log("Card50 config", config);
  // console.log("Card50 readyDatasrc", readyDatasrc);
  // console.log("Card50 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card50 positionConfig", positionConfig);
  return (
    <>
