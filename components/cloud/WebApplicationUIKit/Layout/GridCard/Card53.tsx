...
export default function Card53() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card53 config", config);
  // console.log("Card53 readyDatasrc", readyDatasrc);
  // console.log("Card53 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card53 positionConfig", positionConfig);
  return (
    <>
