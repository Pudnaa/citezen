...
export default function Card54() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card54 config", config);
  // console.log("Card54 readyDatasrc", readyDatasrc);
  // console.log("Card54 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card54 positionConfig", positionConfig);
  return (
    <>
