...
export default function Card56() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card56 config", config);
  // console.log("Card56 readyDatasrc", readyDatasrc);
  // console.log("Card56 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card56 positionConfig", positionConfig);
  return (
    <>
