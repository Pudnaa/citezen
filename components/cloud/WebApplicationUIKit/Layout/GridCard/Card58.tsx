...
export default function Card58() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card58 config", config);
  //   console.log("Card58 readyDatasrc", readyDatasrc);
  // console.log("Card58 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card58 positionConfig", positionConfig);
  return (
    <>
      <div className="flex items-center justify-center w-full h-full py-12 px-4">
        <div className="bg-white max-w-5xl w-full dark:bg-gray-800 shadow rounded py-6">
          <p className="text-xl px-8 font-semibold leading-tight text-gray-800 dark:text-gray-100">
            Transaction History
          </p>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="text-xs md:text-base leading-3 dark:text-gray-100 text-gray-800">
                  ...
                  <td className="pt-6 pl-12">
                    ID&nbsp;:&nbsp;1421412P&nbsp;-&nbsp;24SGE2&nbsp;-&nbsp;876TBJK
                  </td>
                  <td className="pt-6 pl-9">
                    28th&nbsp;Feb,&nbsp;2021|&nbsp;03:52&nbsp;a.m
                  </td>
                  <td className="pt-6 pl-8">
                    <p className="text-xs md:text-base leading-none text-green-700">
                      + $130
                    </p>
                  </td>
                ...
                <tr className="text-xs md:text-base leading-3 dark:text-gray-100 text-gray-800">
                  ...
                  <td className="pt-9 pl-12">
                    ID : 1421412P - 24SGE2 - 876TBJK
                  </td>
                  <td className="pt-9 pl-9">
                    27th&nbsp;Feb,2021&nbsp;|&nbsp;08:48&nbsp;p.m
                  </td>
                ...
                <tr className="text-xs md:text-base leading-3 dark:text-gray-100 text-gray-800">
                  ...
                  <td className="pt-9 pl-8">
                    <p className="text-xs md:text-base leading-none text-red-600">
                      - $50
                    </p>
                  </td>
                  <td className="pl-12 pr-16 pt-9">
                    <div className="flex items-center justify-center w-20 h-5  bg-yellow-100 rounded-full">
                      <p className="text-xs font-medium leading-3 text-yellow-700">
                        ready
                      </p>
                    </div>
                  </td>
                ...
                <tr className="text-xs md:text-base leading-3 dark:text-gray-100 text-gray-800">
                  ...
                  <td className="pl-12 pr-16 pt-9">
                    <div className="flex items-center justify-center w-20 h-5  bg-red-100 rounded-full">
                      <p className="text-xs font-medium leading-3 text-red-700">
                        refund
                      </p>
                    </div>
                  </td>
