...
export default function Card6() {
  ...
  // console.log("Card6 config", config);
  // console.log("Card6 readyDatasrc", readyDatasrc);
  // console.log("Card6 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card6 positionConfig", positionConfig);
  // useEffect(() => {
