...
export default function Card60() {
  ...
  // console.log("Card60 config", config);
  // console.log("Card60 readyDatasrc", readyDatasrc);
  // console.log("Card60 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card60 positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="bg-white max-w-xs sm:max-w-sm  dark:bg-gray-800 shadow rounded py-6 px-4 sm:px-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-semibold leading-3 mt-1 text-gray-500 dark:text-gray-400">
                Unread
              </p>
            </div>
          ...
          <div className="mt-6 pb-3 border-b border-gray-200">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <p className="text-xs font-semibold leading-3 text-right dark:text-gray-400 text-gray-500">
                3 hrs ago
              </p>
            </div>
          </div>
          ...
          <p className="text-xs mt-4 font-semibold leading-none text-indigo-700">
            +12 more
          </p>
        </div>
      </div>
