...
export default function Card61() {
  ...
  // console.log("Card61 config", config);
  // console.log("Card61 readyDatasrc", readyDatasrc);
  // console.log("Card61 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card61 positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="bg-white max-w-sm  dark:bg-gray-800 shadow rounded py-6 px-6">
          <div className="flex items-center">
            <div className="flex items-end">
              <p className="sm:text-4xl text-3xl font-semibold leading-8 text-gray-800 dark:text-gray-100">
                60%
              </p>
              <p className="text-base font-medium leading-none text-gray-500 dark:text-gray-400 ml-2">
                Complete
              </p>
            </div>
          ...
          <div className="mt-12">
            <div>
              ...
              <div className="flex items-center justify-between">
                ...
                <p className="text-base font-semibold leading-3 text-gray-800 dark:text-gray-100">
                  60%
                </p>
              </div>
