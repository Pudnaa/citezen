...
export default function Card63() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card63 config", config);
  // console.log("Card63 readyDatasrc", readyDatasrc);
  // console.log("Card63 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card63 positionConfig", positionConfig);
  return (
    <>
      <div className="flex items-center justify-center w-full h-full py-12 px-4">
        <div className="max-w-sm">
          <div className="p-4 bg-gray-100 shadow rounded-tl rounded-tr dark:bg-gray-700">
            <div className="flex items-center">
              ...
              <div className="sm:pl-12 pl-5 pr-4">
                <p className="text-xl font-semibold leading-5 dark:text-gray-100 text-gray-800">
                  Sweet&nbsp;melody
                </p>
                <p className="text-sm leading-4 pt-2 dark:text-gray-100 text-gray-800">
                  Little Mix
                </p>
                <p className="text-sm leading-4 pt-6 dark:text-gray-400 text-gray-500">
                  Winter Hits 2020
                </p>
              </div>
            </div>
          ...
          <div className="bg-white shadow dark:bg-gray-800 pt-5 px-4 rounded-b">
            <p className="text-xs leading-3 text-gray-500 dark:text-gray-400 uppercase">
              up Next
            </p>
            <div className="flex items-center pt-5 pb-4 border-b border-gray-200">
              <div className="w-9 h-9 rounded">
                <img
                  src="https://i.ibb.co/n8SCrpx/4.png"
                  alt="img"
                  className="w-full h-full"
                />
              </div>
              <div className="flex flex-col pl-6">
                <p className="text-base font-semibold leading-4 dark:text-gray-100 text-gray-800">
                  Midnight sky
                </p>
                <p className="text-xs leading-3 text-gray-800 dark:text-gray-100 pt-2">
                  Miley Cyrus
                </p>
              </div>
            </div>
            <div className="flex items-center pt-5 pb-4">
              <div className="w-9 h-9 rounded">
                <img
                  className="w-full h-full"
                  src="https://i.ibb.co/SdyYvbB/5.png"
                  alt="img"
                />
              </div>
              <div className="flex flex-col pl-6">
