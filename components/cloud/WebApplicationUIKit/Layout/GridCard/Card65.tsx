...
export default function Card65() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card65 config", config);
  // console.log("Card65 readyDatasrc", readyDatasrc);
  // console.log("Card65 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card65 positionConfig", positionConfig);
  return (
    <>
      <div className="flex items-center justify-center w-full h-full py-12 px-4">
        <div className="max-w-xs">
          <div className="bg-gray-100 shadow rounded-tl rounded-tr dark:bg-gray-700">
            <img
              src="https://i.ibb.co/brGrW3g/8.png"
              alt="bg-img"
              className="w-full h-full"
            />
          </div>
          <div className="bg-white shadow dark:bg-gray-800 px-5 rounded-b">
            <p className="w-48 text-base font-semibold leading-5 dark:text-gray-100 pt-4 text-gray-800">
            ...
            <p className="py-2 text-xs leading-4 dark:text-gray-400 text-gray-500">
              When I first got into the advertising business, I was looking for
