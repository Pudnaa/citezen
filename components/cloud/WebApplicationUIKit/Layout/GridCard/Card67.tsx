...
export default function Card67() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card67 config", config);
  // console.log("Card67 readyDatasrc", readyDatasrc);
  // console.log("Card67 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card67 positionConfig", positionConfig);
  // useEffect(() => {
