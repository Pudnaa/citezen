...
export default function Card68() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card68 config", config);
  // console.log("Card68 readyDatasrc", readyDatasrc);
  // console.log("Card68 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card68 positionConfig", positionConfig);
  // useEffect(() => {
