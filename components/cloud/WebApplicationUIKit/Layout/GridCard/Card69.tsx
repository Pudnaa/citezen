...
export default function Card69() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card69 config", config);
  // console.log("Card69 readyDatasrc", readyDatasrc);
  // console.log("Card69 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card69 positionConfig", positionConfig);
  // useEffect(() => {
