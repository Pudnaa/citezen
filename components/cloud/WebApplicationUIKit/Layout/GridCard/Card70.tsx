...
export default function Card70() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card70 config", config);
  // console.log("Card70 readyDatasrc", readyDatasrc);
  // console.log("Card70 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card70 positionConfig", positionConfig);
  // useEffect(() => {
