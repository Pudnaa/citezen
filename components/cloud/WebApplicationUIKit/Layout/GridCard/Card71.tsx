...
export default function Card71() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card71 config", config);
  // console.log("Card71 readyDatasrc", readyDatasrc);
  // console.log("Card71 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card71 positionConfig", positionConfig);
  // useEffect(() => {
