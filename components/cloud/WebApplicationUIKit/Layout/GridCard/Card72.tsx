...
export default function Card72() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card72 config", config);
  // console.log("Card72 readyDatasrc", readyDatasrc);
  // console.log("Card72 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card72 positionConfig", positionConfig);
  // useEffect(() => {
