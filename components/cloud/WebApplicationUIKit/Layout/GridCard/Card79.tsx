...
export default function Card79() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card79 config", config);
  // console.log("Card79 readyDatasrc", readyDatasrc);
  // console.log("Card79 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card79 positionConfig", positionConfig);
  return (
    <>
