...
export default function Card8() {
  ...
  // console.log("Card8 config", config);
  // console.log("Card8 readyDatasrc", readyDatasrc);
  // console.log("Card8 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card8 positionConfig", positionConfig);
  return (
    <>
      <div className="flex items-center justify-center py-8 px-4">
        <div className="md:w-96 rounded shadow-lg py-4 px-5 bg-white dark:bg-gray-800">
          ...
          <h2 className="pt-2 text-xs leading-3 dark:text-gray-400 text-gray-600 dark:text-gray-500">
