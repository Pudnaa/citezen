...
export default function Card88() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card88 config", config);
  // console.log("Card88 readyDatasrc", readyDatasrc);
  // console.log("Card88 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card88 positionConfig", positionConfig);
