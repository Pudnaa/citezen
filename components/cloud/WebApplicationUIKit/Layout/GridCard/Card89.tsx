...
export default function Card89() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card89 config", config);
  // console.log("Card89 readyDatasrc", readyDatasrc);
  // console.log("Card89 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card89 positionConfig", positionConfig);
  return (
    <>
