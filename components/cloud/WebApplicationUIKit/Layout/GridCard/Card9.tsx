...
export default function Card9() {
  ...
  // console.log("Card9 config", config);
  // console.log("Card9 readyDatasrc", readyDatasrc);
  // console.log("Card9 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card9 positionConfig", positionConfig);
  return (
    <>
      <div className="flex items-center justify-center py-8 px-4">
        <div className="md:w-96 rounded shadow-lg p-5 bg-indigo-700">
          ...
          >
            <path
              id="Fill-3"
              d="M14.8461 1.57112H16.7062V0H14.8461V1.57112Z"
              fill="#C6C6C6"
            />
            <path
              id="Fill-4"
              d="M16.7062 1.57112H18.5662V0H16.7062V1.57112Z"
              fill="#EEEEEE"
            />
            <path
              id="Fill-5"
          ...
          <h1 className="text-lg font-bold leading-7 pt-6 text-white">
            Learn, share and get help from our community
          </h1>
          <p className="pt-4 text-xs leading-5 pr-12 text-white">
          ...
          <div className="pt-7 flex items-center justify-between">
            <button className="text-white rounded bg-transparent focus:outline-none hover:opacity-90 p-2 text-xs font-medium leading-3">
              Maybe Later
            </button>
            <button className="text-indigo-700 rounded bg-gray-50 focus:outline-none hover:opacity-90 p-2 text-xs font-medium leading-3">
              Join TUK on Discord{" "}
            </button>
          </div>
        </div>
