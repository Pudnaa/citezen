...
export default function Card90() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card90 config", config);
  // console.log("Card90 readyDatasrc", readyDatasrc);
  // console.log("Card90 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card90 positionConfig", positionConfig);
  // useEffect(() => {
  //     var config = {
  //         type: "doughnut",
  //         data: {
