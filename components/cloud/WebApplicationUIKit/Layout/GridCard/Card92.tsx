...
export default function Card92() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card92 config", config);
  // console.log("Card92 readyDatasrc", readyDatasrc);
  // console.log("Card92 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card92 positionConfig", positionConfig);
  return (
    <>
