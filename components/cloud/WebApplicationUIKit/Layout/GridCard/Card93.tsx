...
export default function Card93() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card93 config", config);
  // console.log("Card93 readyDatasrc", readyDatasrc);
  // console.log("Card93 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card93 positionConfig", positionConfig);
  // useEffect(() => {
