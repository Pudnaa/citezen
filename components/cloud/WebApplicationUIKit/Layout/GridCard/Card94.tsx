...
export default function Card94() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("Card94 config", config);
  // console.log("Card94 readyDatasrc", readyDatasrc);
  // console.log("Card94 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card94 positionConfig", positionConfig);
  // useEffect(() => {
