...
const Card97 = () => {
  ...
  // console.log("Card97 config", config);
  // console.log("Card97 readyDatasrc", readyDatasrc);
  // console.log("Card97 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card97 positionConfig", positionConfig);
  return (
    <>
            ...
            <div className="sm:flex items-start">
              ...
              <div className="ml-4">
                <div className="py-2 px-4 sm:top-8 top-12 absolute right-0 bg-green-100 flex items-center justify-center rounded-tl-3xl rounded-bl-3xl">
                  <p className="text-xs font-semibold text-center text-green-700">
                    SPONSORED
                  </p>
                </div>
                <div className="sm:pt-0 pt-4">
                  <p className="text-xl font-semibold leading-5 pt-1 text-gray-800 dark:text-gray-100">
                    Product Designer
                  </p>
                ...
                <div className="mt-2">
                  <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
                    We are looking to hire a freelance UI/UX designer fluent in
