...
function Card99() {
  ...
  // console.log("Card99 config", config);
  // console.log("Card99 readyDatasrc", readyDatasrc);
  // console.log("Card99 widgetnemgooReady", widgetnemgooReady);
  // console.log("Card99 positionConfig", positionConfig);
  return (
    <>
                ...
                <div className="sm:flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between sm:mt-0 mt-3">
                    <div className="w-16 mr-6 sm:ml-4 flex items-center justify-center bg-green-100 rounded-full">
                      <p className="text-xs font-semibold leading-loose text-center text-green-700">
                        DESIGN
                      </p>
                    </div>
                    <svg
