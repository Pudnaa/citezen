...
export default function ChartCard() {
  ...
  // console.log("ChartCard config", config);
  // console.log("ChartCard readyDatasrc", readyDatasrc);
  // console.log("ChartCard widgetnemgooReady", widgetnemgooReady);
  // console.log("ChartCard positionConfig", positionConfig);
  // useEffect(() => {
