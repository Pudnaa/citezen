...
function CompactStatCards() {
  ...
  // console.log("CompactStatCards config", config);
  // console.log("CompactStatCards readyDatasrc", readyDatasrc);
  // console.log("CompactStatCards widgetnemgooReady", widgetnemgooReady);
  // console.log("CompactStatCards positionConfig", positionConfig);
  return (
    <>
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 bg-gray-200 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 rounded shadow">
          <div className="border-l-4 border-indigo-300 flex items-center justify-between p-3">
            <h3 className="leading-4 text-gray-800 dark:text-gray-100 font-normal text-base">
              Total Posts
            </h3>
...
export default CompactStatCards;
