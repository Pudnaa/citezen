...
export default function EventCard1() {
  ...
  // console.log("EventCard1 config", config);
  // console.log("EventCard1 readyDatasrc", readyDatasrc);
  // console.log("EventCard1 widgetnemgooReady", widgetnemgooReady);
  // console.log("EventCard1 positionConfig", positionConfig);
  return (
    <div className="w-full h-full flex items-center justify-center py-8 md:px-0 px-4 dark:bg-gray-900">
      <div className="bg-white dark:bg-gray-800 pb-6 shadow-xl max-w-sm">
        <img
          className="w-full"
          src="https://cdn.tuk.dev/assets/templates/virtual-event-management/events-1.png"
          alt="costume-party"
        />
          ...
          <div className="flex items-center relative">
            <div className="w-6 h-6 rounded-full flex justify-center items-center">
              <img
                ...
                src="https://cdn.tuk.dev/assets/templates/virtual-event-management/events-5.png"
                alt="profile"
              />
            </div>
            <div className="w-6 h-6 rounded-full flex justify-center items-center -ml-2">
              <img
                className="object-cover object-center h-full w-full"
                src="https://cdn.tuk.dev/assets/templates/virtual-event-management/events-6.png"
                alt="profile"
              />
            </div>
            <div className="w-6 h-6 rounded-full flex justify-center items-center -ml-2">
              <img
                className="object-cover object-center h-full w-full"
                src="https://cdn.tuk.dev/assets/templates/virtual-event-management/events-7.png"
                alt="profile"
              />
            </div>
            <div className="w-6 h-6 rounded-full flex justify-center border-2 border-white bg-indigo-400 items-center -ml-2">
              ...
              >
                <path
                  d="M4.557 0.838V3.827H7.406V4.772H4.557V7.782H3.535V4.772H0.7V3.827H3.535V0.838H4.557Z"
                  fill="white"
                />
              </svg>
            </div>
