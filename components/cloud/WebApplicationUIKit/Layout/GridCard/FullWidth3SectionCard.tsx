...
function FullWidth3SectionCard() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("FullWidth3SectionCard config", config);
  // console.log("FullWidth3SectionCard readyDatasrc", readyDatasrc);
  // console.log("FullWidth3SectionCard widgetnemgooReady", widgetnemgooReady);
  // console.log("FullWidth3SectionCard positionConfig", positionConfig);
  return (
    <>
...
export default FullWidth3SectionCard;
