...
function FullWidth3SectionProjectCard() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("FullWidth3SectionProjectCard config", config);
  // console.log("FullWidth3SectionProjectCard readyDatasrc", readyDatasrc);
  // console.log("FullWidth3SectionProjectCard widgetnemgooReady", widgetnemgooReady);
  // console.log("FullWidth3SectionProjectCard positionConfig", positionConfig);
  return (
    <>
            ...
            <div className="flex flex-col lg:flex-row mx-auto w-full bg-white dark:bg-gray-800 shadow rounded">
              <div className="w-full lg:w-1/3 p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm font-normal">
                  To many naive users of the platform, a redesign may look just
                  like a facelift. No more, no less. However, for a User
                  Experience designer, the entire redesign process means much
                  more than a lot of research, meticulous planning, iterating,
                ...
                <div className="flex items-center mt-6 w-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm font-normal ml-2">
                    +2 more participants
                  </p>
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/3 p-6">
                <div className="mb-4 flex items-center justify-between">
                  <p className="text-gray-600 dark:text-gray-400 text-sm font-normal leading-3 tracking-normal">
                    User Experience Research
                  </p>
                  <p className="text-xs text-indigo-700 dark:text-indigo-600 font-normal leading-3 tracking-normal">
                    7/12
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-800 dark:text-gray-100 font-normal mb-1 tracking-normal">
                      Earnings
                    </p>
                    <h2 className="text-sm xl:text-lg text-gray-600 dark:text-gray-400 font-bold tracking-normal">
                      $357,655
                    </h2>
                  </div>
                  <div>
...
export default FullWidth3SectionProjectCard;
