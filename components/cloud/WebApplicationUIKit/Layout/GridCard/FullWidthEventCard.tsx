...
function FullWidthEventCard() {
  ...
  // console.log("FullWidthEventCard config", config);
  // console.log("FullWidthEventCard readyDatasrc", readyDatasrc);
  // console.log("FullWidthEventCard widgetnemgooReady", widgetnemgooReady);
  // console.log("FullWidthEventCard positionConfig", positionConfig);
  return (
    <>
      ...
      <div className="flex flex-col-reverse lg:flex-row w-full bg-white dark:bg-gray-800 shadow rounded">
        <div className="w-full lg:w-1/2">
          ...
          <div className="px-5 lg:px-5 md:px-10 py-3 lg:py-4 flex flex-row items-center justify-between border-t border-gray-300">
            <div className="flex items-center">
              <div className="flex items-center">
                <div className="bg-white rounded-full w-5 h-5 flex shrink-0 justify-center items-center relative">
                  <input
                    defaultChecked
                    type="radio"
                    name="radio"
