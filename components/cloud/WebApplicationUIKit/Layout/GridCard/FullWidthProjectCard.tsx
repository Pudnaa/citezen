...
function FullWidthProjectCard() {
  ...
  // console.log("FullWidthProjectCard config", config);
  // console.log("FullWidthProjectCard readyDatasrc", readyDatasrc);
  // console.log("FullWidthProjectCard widgetnemgooReady", widgetnemgooReady);
  // console.log("FullWidthProjectCard positionConfig", positionConfig);
  return (
    <>
...
export default FullWidthProjectCard;
