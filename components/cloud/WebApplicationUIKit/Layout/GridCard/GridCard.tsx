...
function GridCard() {
  ...
  // console.log("GridCard config", config);
  // console.log("GridCard readyDatasrc", readyDatasrc);
  // console.log("GridCard widgetnemgooReady", widgetnemgooReady);
  // console.log("GridCard positionConfig", positionConfig);
  return (
    <>
