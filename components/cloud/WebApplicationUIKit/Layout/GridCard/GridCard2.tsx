...
function GridCard2() {
  ...
  // console.log("GridCard2 config", config);
  // console.log("GridCard2 readyDatasrc", readyDatasrc);
  // console.log("GridCard2 widgetnemgooReady", widgetnemgooReady);
  // console.log("GridCard2 positionConfig", positionConfig);
