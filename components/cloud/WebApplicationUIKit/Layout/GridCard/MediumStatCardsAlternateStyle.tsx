...
function MediumStatCardsAlternateStyle() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("MediumStatCardsAlternateStyle config", config);
  // console.log("MediumStatCardsAlternateStyle readyDatasrc", readyDatasrc);
  // console.log("MediumStatCardsAlternateStyle widgetnemgooReady", widgetnemgooReady);
  // console.log("MediumStatCardsAlternateStyle positionConfig", positionConfig);
  return (
    <>
...
export default MediumStatCardsAlternateStyle;
