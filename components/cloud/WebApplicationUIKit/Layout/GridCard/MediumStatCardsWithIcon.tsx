...
function MediumStatCardsWithIcon() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("MediumStatCardsWithIcon config", config);
  // console.log("MediumStatCardsWithIcon readyDatasrc", readyDatasrc);
  // console.log("MediumStatCardsWithIcon widgetnemgooReady", widgetnemgooReady);
  // console.log("MediumStatCardsWithIcon positionConfig", positionConfig);
  return (
    <>
...
export default MediumStatCardsWithIcon;
