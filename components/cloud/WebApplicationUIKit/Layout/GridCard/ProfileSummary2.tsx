...
function ProfileSummary2() {
  ...
  // console.log("ProfileSummary2 config", config);
  // console.log("ProfileSummary2 readyDatasrc", readyDatasrc);
  // console.log("ProfileSummary2 widgetnemgooReady", widgetnemgooReady);
  // console.log("ProfileSummary2 positionConfig", positionConfig);
  return (
    <>
...
export default ProfileSummary2;
