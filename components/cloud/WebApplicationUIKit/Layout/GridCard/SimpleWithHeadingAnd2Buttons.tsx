...
export default function SimpleWithHeadingAnd2Buttons() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("SimpleWithHeadingAnd2Buttons config", config);
  // console.log("SimpleWithHeadingAnd2Buttons readyDatasrc", readyDatasrc);
  // console.log("SimpleWithHeadingAnd2Buttons widgetnemgooReady", widgetnemgooReady);
  // console.log("SimpleWithHeadingAnd2Buttons positionConfig", positionConfig);
  return (
    <>
      <div className="mx-auto container dark:bg-gray-900 xl:px-0 px-4 py-16">
        <div className="xl:w-6/12">
          <div className="w-full h-48">
            <img
              src="https://i.ibb.co/8BNQmFB/Bitmap.png"
              className="w-full h-full"
            />
          </div>
          <div className="flex items-center pt-5">
            <p className="text-indigo-700 dark:text-indigo-600 text-sm font-normal pr-3">
              7th July 2020
            </p>
            <p className="text-indigo-700 dark:text-indigo-600 text-sm font-normal border-l border-gray-300 pl-3">
              9:00pm - 11:00pm
            </p>
          </div>
          <div className="xl:flex items-start py-5">
            <div>
              <p className="font-bold xl:text-3xl text-xl text-gray-900 dark:text-gray-100">
                Metropolitan City Art Gallery Showcase Exhibition
              </p>
            </div>
            <div className="flex items-center pt-5 xl:w-1/2">
              <p className="text-green-500 text-sm font-normal pr-3">
                Available
              </p>
              <p className="text-green-500 text-sm font-normal border-l border-gray-300 pl-3">
                86/90 seats booked
              </p>
            </div>
          </div>
          ...
          <div>
            <p className="text-sm leading-7 mt-5 text-gray-600 dark:text-gray-400">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Et
              quidem faciunt, ut de voluptate ponit, quod summum bonum sit aut
              rerum et quidem, lorem ipsum dolor sit amet, consectetur
              adipiscing elit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua. Et quidem faciunt, ut de voluptate ponit,
              quod summum bonum sit aut.
            </p>
          </div>
        </div>
      </div>
