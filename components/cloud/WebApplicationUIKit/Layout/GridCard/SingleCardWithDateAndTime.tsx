...
function SingleCardWithDateAndTime() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("SingleCardWithDateAndTime config", config);
  // console.log("SingleCardWithDateAndTime readyDatasrc", readyDatasrc);
  // console.log("SingleCardWithDateAndTime widgetnemgooReady", widgetnemgooReady);
  // console.log("SingleCardWithDateAndTime positionConfig", positionConfig);
  return (
    <div>
...
export default SingleCardWithDateAndTime;
