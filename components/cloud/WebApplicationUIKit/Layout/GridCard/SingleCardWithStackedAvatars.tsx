...
function SingleCardWithStackedAvatars() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("SingleCardWithStackedAvatars config", config);
  // console.log("SingleCardWithStackedAvatars readyDatasrc", readyDatasrc);
  // console.log("SingleCardWithStackedAvatars widgetnemgooReady", widgetnemgooReady);
  // console.log("SingleCardWithStackedAvatars positionConfig", positionConfig);
  return (
    <div>
      <div className="mx-auto container py-12 px-6 dark:bg-gray-900 flex justify-center items-center ">
        <div className="max-w-xs">
          <div className="w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-3 py-5 px-4">
            ...
            <h4 className="text-gray-800 dark:text-gray-100 font-semibold mb-4">
            ...
            <div className="flex items-center justify-between text-gray-600 dark:text-gray-400">
              <div className="mb-5 rounded-full border border-gray-400 py-1 pl-2 pr-3 flex items-center">
                <svg
                  ...
                  className="shrink-0 icon icon-tabler icon-tabler-alarm"
                  width={16}
                  height={16}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
...
export default SingleCardWithStackedAvatars;
