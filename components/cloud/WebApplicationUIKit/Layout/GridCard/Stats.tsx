...
function Stats() {
  ...
  // console.log("Stats config", config);
  // console.log("Stats readyDatasrc", readyDatasrc);
  // console.log("Stats widgetnemgooReady", widgetnemgooReady);
  // console.log("Stats positionConfig", positionConfig);
  return (
    <>
