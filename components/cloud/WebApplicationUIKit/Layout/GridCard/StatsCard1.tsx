...
export default function StatsCard1() {
  ...
  // console.log("StatsCard1 config", config);
  // console.log("StatsCard1 readyDatasrc", readyDatasrc);
  // console.log("StatsCard1 widgetnemgooReady", widgetnemgooReady);
  // console.log("StatsCard1 positionConfig", positionConfig);
  return (
      ...
      <div className="w-10/12 flex justify-center items-center">
        <div className="flex flex-wrap">
          ...
          <div className="py-6 pl-4 w-64 m-4 bg-gray-100 dark:bg-gray-800 rounded-sm border border-gray-100 dark:border-gray-700">
            <p className="text-4xl font-bold leading-9 text-gray-700 dark:text-gray-400">
              $768,89
            </p>
            <p className="text-lg leading-none text-gray-600 dark:text-gray-400 mt-3">
              Revenue Generated
            </p>
          </div>
          <div className="py-6 pl-4 w-64 m-4 bg-gray-100 dark:bg-gray-800 rounded-sm border border-gray-100 dark:border-gray-700">
