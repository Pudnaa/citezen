...
export default function TicketWithBarcode() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("TicketWithBarcode config", config);
  // console.log("TicketWithBarcode readyDatasrc", readyDatasrc);
  // console.log("TicketWithBarcode widgetnemgooReady", widgetnemgooReady);
  // console.log("TicketWithBarcode positionConfig", positionConfig);
  return (
