...
export default function Header1() {
  ...
  // console.log("Header1 config", config);
  // console.log("Header1 readyDatasrc", readyDatasrc);
  // console.log("Header1 widgetnemgooReady", widgetnemgooReady);
  // console.log("Header1 positionConfig", positionConfig);
