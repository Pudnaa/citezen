...
export default function Header2() {
  ...
  // console.log("Header2 config", config);
  // console.log("Header2 readyDatasrc", readyDatasrc);
  // console.log("Header2 widgetnemgooReady", widgetnemgooReady);
  // console.log("Header2 positionConfig", positionConfig);
  return (
