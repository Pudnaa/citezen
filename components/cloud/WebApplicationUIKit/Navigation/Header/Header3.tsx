...
export default function Header3() {
  ...
  // console.log("Header3 config", config);
  // console.log("Header3 readyDatasrc", readyDatasrc);
  // console.log("Header3 widgetnemgooReady", widgetnemgooReady);
  // console.log("Header3 positionConfig", positionConfig);

  //gocars-n headers
  return widgetnemgooReady.type === "gocars" ? (
    <div className="z-50" style={{ zIndex: 1000 }}>
      <div className=" bg-yellow-400 py-3 px-5">
        <div className="max-w-screen-xl mx-auto flex justify-end">
          <div className="font-bold text-lg">Дэлгүүр</div>
          <div className="font-bold text-lg mx-6">Сэлбэг захиалах</div>
          <div className="font-bold text-lg">Миний аккоунт</div>
          <div className="font-bold text-lg ml-6">Холбоо барих</div>
        </div>
      </div>
      <div
        className="w-full"
        style={{ height: "156px", backgroundColor: "#132530" }}
      >
        <div className="max-w-screen-xl mx-auto px-2">
          <div className="flex justify-end text-white py-4">
            <div className="mr-6">love</div>
            <div className="flex">
          ...
          <div className="items-center text-white">
            <div className="flex justify-between">
              <AtomLink
                item="/page/1637226489768071"
                children={
                  <div className="text-yellow-400 text-5xl font-bold whitespace-nowrap">
                    GO CARS
                  </div>
                }
              />
              <div className="flex flex-nowrap">
                <input
                  type="text"
                  className="h-10 rounded-lg text-black pr-10 w-96"
                  placeholder="Хайх эд ангийн нэр эсвэл дугаарыг оруулна уу"
                />
                <button className="py-3 px-8 bg-blue-600 rounded-lg ml-1 h-10">
                  Search
                </button>
              </div>
              <div
                className="items-center py-1 px-3 rounded-lg"
                style={{ backgroundColor: "#0a1a24", minWidth: "260px" }}
              >
                <div className="flex justify-between h-full">
                  <div className="flex">
                    <div className="flex flex-col justify-center">
                      <img
                        src="https://www.autodoc.co.uk/atd/img/icons/svg/cart-header.svg"
                        alt=""
                        className="w-9 h-9"
                      />
                    </div>

                    <div className="text-xs h-full flex flex-col justify-around ml-2">
                      <div className="font-medium" style={{ color: "#a7adb4" }}>
                        <span>0 </span>
                        <span>items</span>
                      </div>
                      <p className="text-gray-500">#88-7337</p>
                    </div>
                  </div>
                  <div className="h-full flex items-center ml-5">
                    <div className="mr-2">
                      <span className="text-yellow-400 text-2xl my-auto whitespace-nowrap">
                        ₮ 160'000'000
                      </span>
                    </div>
                    <div className="">
                      <i className="fas fa-angle-down my-auto text-gray-500"></i>
                    </div>
                  </div>
                </div>
              </div>
