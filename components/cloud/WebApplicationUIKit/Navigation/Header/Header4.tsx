...
export default function Header4() {
  ...
  // console.log("Header4 config", config);
  // console.log("Header4 readyDatasrc", readyDatasrc);
  // console.log("Header4 widgetnemgooReady", widgetnemgooReady);
  // console.log("Header4 positionConfig", positionConfig);
          ...
          <div className="2xl:container 2xl:mx-auto">
            <nav>
              <div className=" flex flex-row justify-between">
                <div className=" flex space-x-3 items-center py-5 lg:pl-7 sm:pl-6 pl-4 pr-8">
                  <svg
