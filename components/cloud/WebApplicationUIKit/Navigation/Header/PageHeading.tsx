...
export default function PageHeading() {
  ...
  // console.log("PageHeading config", config);
  // console.log("PageHeading readyDatasrc", readyDatasrc);
  // console.log("PageHeading widgetnemgooReady", widgetnemgooReady);
  // console.log("PageHeading positionConfig", positionConfig);
  return (
    <>
