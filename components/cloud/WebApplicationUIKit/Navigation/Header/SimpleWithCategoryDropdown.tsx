...
const SimpleWithCategoryDropdown = () => {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("SimpleWithCategoryDropdown config", config);
  // console.log("SimpleWithCategoryDropdown readyDatasrc", readyDatasrc);
  // console.log("SimpleWithCategoryDropdown widgetnemgooReady", widgetnemgooReady);
  // console.log("SimpleWithCategoryDropdown positionConfig", positionConfig);
  return (
    <div className="py-14 px-6  md:flex items-center w-full justify-between">
      ...
      <div className="flex  flex-col-reverse mt-5 md:mt-0 md:flex-row md:items-center">
...
export default SimpleWithCategoryDropdown;
