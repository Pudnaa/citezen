...
export default function BlackLeftAlignedWithIcons() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("BlackLeftAlignedWithIcons config", config);
  // console.log("BlackLeftAlignedWithIcons readyDatasrc", readyDatasrc);
  // console.log("BlackLeftAlignedWithIcons widgetnemgooReady", widgetnemgooReady);
  // console.log("BlackLeftAlignedWithIcons positionConfig", positionConfig);
  return (
    <>
          ...
          <div className="container px-6 h-16 flex justify-between items-center lg:items-stretch mx-auto">
            ...
            <div className="h-full hidden xl:flex items-center justify-end">
              <div className="h-full flex">
                <div className="px-6 h-full flex items-center justify-center border-l border-gray-700 text-gray-400 ">
                  <input
                    type="text"
