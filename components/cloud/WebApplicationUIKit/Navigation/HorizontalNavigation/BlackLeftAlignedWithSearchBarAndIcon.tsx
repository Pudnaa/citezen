...
export default function BlackLeftAlignedWithSearchBarAndIcon() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("BlackLeftAlignedWithSearchBarAndIcon config", config);
  // console.log("BlackLeftAlignedWithSearchBarAndIcon readyDatasrc", readyDatasrc);
  // console.log("BlackLeftAlignedWithSearchBarAndIcon widgetnemgooReady", widgetnemgooReady);
  // console.log("BlackLeftAlignedWithSearchBarAndIcon positionConfig", positionConfig);
  return (
    <>
          ...
          <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
            ...
            <div className="flex items-center xl:hidden">
              <ul className="p-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16 hidden">
                ...
                <li className="border-b border-gray-300 flex md:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pt-2 pb-4 hover:text-indigo-700  items-center focus:text-indigo-700 focus:outline-none">
                  ...
                  <div className="w-full pt-4">
                    <div className="flex justify-center mb-4 w-full">
                      <div className="relative w-full">
                        ...
                        <input
                          className="bg-gray-100 focus:outline-none rounded w-full text-sm text-gray-500 bpl-10 py-2"
                          type="text"
                          placeholder="Search"
                        />
                      </div>
