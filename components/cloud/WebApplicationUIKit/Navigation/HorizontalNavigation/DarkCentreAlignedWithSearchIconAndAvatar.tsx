...
export default function DarkCentreAlignedWithSearchIconAndAvatar() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("DarkCentreAlignedWithSearchIconAndAvatar config", config);
  // console.log("DarkCentreAlignedWithSearchIconAndAvatar readyDatasrc", readyDatasrc);
  // console.log("DarkCentreAlignedWithSearchIconAndAvatar widgetnemgooReady", widgetnemgooReady);
  // console.log("DarkCentreAlignedWithSearchIconAndAvatar positionConfig", positionConfig);
  return (
    <>
