...
export default function DarkWithNavFlushedLeft() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("DarkWithNavFlushedLeft config", config);
  // console.log("DarkWithNavFlushedLeft readyDatasrc", readyDatasrc);
  // console.log("DarkWithNavFlushedLeft widgetnemgooReady", widgetnemgooReady);
  // console.log("DarkWithNavFlushedLeft positionConfig", positionConfig);
  return (
    <>
          ...
          <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
            <div className="flex items-center">
              ...
              <ul className="pr-32 xl:flex hidden items-center h-full">
                ...
                <li
                  className="cursor-pointer hover:text-indigo-700 transition duration-150 ease-in-out h-full flex items-center text-sm text-white mx-10 tracking-normal relative "
                ...
                <li className="cursor-pointer hover:text-indigo-700 transition duration-150 ease-in-out h-full flex items-center text-sm text-white mr-10 tracking-normal ">
                  Performance
                </li>
                <li
