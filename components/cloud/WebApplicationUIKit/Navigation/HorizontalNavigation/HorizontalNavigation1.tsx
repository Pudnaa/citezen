...
export default function HorizontalNavigation1() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("HorizontalNavigation1 config", config);
  // console.log("HorizontalNavigation1 readyDatasrc", readyDatasrc);
  // console.log("HorizontalNavigation1 widgetnemgooReady", widgetnemgooReady);
  // console.log("HorizontalNavigation1 positionConfig", positionConfig);
  return (
    <>
