...
export default function LeftAlignedWithSearchBarAndIcon() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("LeftAlignedWithSearchBarAndIcon config", config);
  // console.log("LeftAlignedWithSearchBarAndIcon readyDatasrc", readyDatasrc);
  // console.log("LeftAlignedWithSearchBarAndIcon widgetnemgooReady", widgetnemgooReady);
  // console.log("LeftAlignedWithSearchBarAndIcon positionConfig", positionConfig);
  return (
    <>
