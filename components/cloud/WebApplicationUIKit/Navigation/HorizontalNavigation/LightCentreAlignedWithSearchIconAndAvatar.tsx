...
export default function LightCentreAlignedWithSearchIconAndAvatar() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("LightCentreAlignedWithSearchIconAndAvatar config", config);
  // console.log("LightCentreAlignedWithSearchIconAndAvatar readyDatasrc", readyDatasrc);
  // console.log("LightCentreAlignedWithSearchIconAndAvatar widgetnemgooReady", widgetnemgooReady);
  // console.log("LightCentreAlignedWithSearchIconAndAvatar positionConfig", positionConfig);
  return (
    <>
      <div className="bg-gray-200 h-full w-full">
        ...
        <nav className="w-full mx-auto bg-white shadow xl:block hidden">
          <div className="container px-6 h-16 flex items-center lg:items-stretch justify-between mx-auto">
            <div className="w-auto flex items-center">
              <div className="rounded-full relative p-3 flex justify-end text-gray-500  items-center ">
                <input
                  type="text"
            ...
            <ul className="flex items-center justify-center h-full">
              ...
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-gray-800 ml-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">
                Products
              </li>
              ...
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-gray-800 mr-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">
                Performance
              </li>
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-gray-800 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">
                Deliverables
              </li>
            </ul>
            <div
        ...
        <nav>
          ...
          <div
            className={
              show
                ? "absolute w-full h-full transform -translate-x-0 z-40 xl:hidden"
