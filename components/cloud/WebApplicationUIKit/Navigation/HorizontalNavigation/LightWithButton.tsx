...
export default function LightWithButton() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("LightWithButton config", config);
  // console.log("LightWithButton readyDatasrc", readyDatasrc);
  // console.log("LightWithButton widgetnemgooReady", widgetnemgooReady);
  // console.log("LightWithButton positionConfig", positionConfig);
  return (
    <>
