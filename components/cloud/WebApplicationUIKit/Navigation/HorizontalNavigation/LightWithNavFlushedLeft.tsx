...
export default function LightWithNavFlushedLeft() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("LightWithNavFlushedLeft config", config);
  // console.log("LightWithNavFlushedLeft readyDatasrc", readyDatasrc);
  // console.log("LightWithNavFlushedLeft widgetnemgooReady", widgetnemgooReady);
  // console.log("LightWithNavFlushedLeft positionConfig", positionConfig);
  return (
    <>
