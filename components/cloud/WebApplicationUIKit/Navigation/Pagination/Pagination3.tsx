...
export default function Pagination3() {
  ...
  // console.log("Pagination3 config", config);
  // console.log("Pagination3 readyDatasrc", readyDatasrc);
  // console.log("Pagination3 widgetnemgooReady", widgetnemgooReady);
  // console.log("Pagination3 positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="flex justify-center items-center py-14">
          <div className="h-8 border flex justify-between">
            ...
            <div className="flex justify-center md:mx-14 lg:mx-20 mx-10 items-center flex-row space-x-2.5 text-sm font-medium leading-none text-gray-600">
              ...
              <div>
                <p className="hover:text-white hover:bg-indigo-700 cursor-pointer p-1.5 text-center rounded">
                  2
                </p>
              </div>
              <div>
                <p className="text-white bg-indigo-700 p-1.5 cursor-pointer text-center rounded">
                  3
                </p>
              </div>
              <div>
