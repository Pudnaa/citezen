...
const ActiveIndigo = () => {
  ...
  // console.log("ActiveIndigo config", config);
  // console.log("ActiveIndigo readyDatasrc", readyDatasrc);
  // console.log("ActiveIndigo widgetnemgooReady", widgetnemgooReady);
  // console.log("ActiveIndigo positionConfig", positionConfig);
  return (
    <div>
