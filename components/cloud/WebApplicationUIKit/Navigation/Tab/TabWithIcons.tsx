...
const TabWithIcons = () => {
  ...
  // console.log("TabWithIcons config", config);
  // console.log("TabWithIcons readyDatasrc", readyDatasrc);
  // console.log("TabWithIcons widgetnemgooReady", widgetnemgooReady);
  // console.log("TabWithIcons positionConfig", positionConfig);
  return (
    <div>
