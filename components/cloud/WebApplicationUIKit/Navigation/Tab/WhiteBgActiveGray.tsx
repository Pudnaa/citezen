...
const WhiteBgActiveGray = () => {
  ...
  // console.log("WhiteBgActiveGray config", config);
  // console.log("WhiteBgActiveGray readyDatasrc", readyDatasrc);
  // console.log("WhiteBgActiveGray widgetnemgooReady", widgetnemgooReady);
  // console.log("WhiteBgActiveGray positionConfig", positionConfig);
  return (
    <div>
...
export default WhiteBgActiveGray;
