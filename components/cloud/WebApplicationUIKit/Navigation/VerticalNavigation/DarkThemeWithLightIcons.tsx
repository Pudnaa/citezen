...
export default function DarkThemeWithLightIcons() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("DarkThemeWithLightIcons config", config);
  // console.log("DarkThemeWithLightIcons readyDatasrc", readyDatasrc);
  // console.log("DarkThemeWithLightIcons widgetnemgooReady", widgetnemgooReady);
  // console.log("DarkThemeWithLightIcons positionConfig", positionConfig);
