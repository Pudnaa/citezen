...
export default function Sidebar2() {
  ...
  // console.log("Sidebar2 config", config);
  // console.log("Sidebar2 readyDatasrc", readyDatasrc);
  // console.log("Sidebar2 widgetnemgooReady", widgetnemgooReady);
  // console.log("Sidebar2 positionConfig", positionConfig);
