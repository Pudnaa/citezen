...
export default function Sidebar3() {
  ...
  // console.log("Sidebar3 config", config);
  // console.log("Sidebar3 readyDatasrc", readyDatasrc);
  // console.log("Sidebar3 widgetnemgooReady", widgetnemgooReady);
  // console.log("Sidebar3 positionConfig", positionConfig);
