...
export default function Sidebar4() {
  ...
  // console.log("Sidebar4 config", config);
  // console.log("Sidebar4 readyDatasrc", readyDatasrc);
  // console.log("Sidebar4 widgetnemgooReady", widgetnemgooReady);
  // console.log("Sidebar4 positionConfig", positionConfig);
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="   mt-6 flex flex-col px-6 justify-start items-center  w-full   ">
