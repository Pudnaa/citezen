...
export default function Sidebar6() {
  ...
  // console.log("Sidebar6 config", config);
  // console.log("Sidebar6 readyDatasrc", readyDatasrc);
  // console.log("Sidebar6 widgetnemgooReady", widgetnemgooReady);
  // console.log("Sidebar6 positionConfig", positionConfig);
        ...
        <div className="xl:mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-3 pb-5 ">
          <div className=" relative focus:outline-none flex jusitfy-start w-full   text-gray-800 rounded  items-center border-gray-300 focus:border-gray-400 border  ">
            <input
              type="text"
              placeholder="Search"
              className="placeholder-gray-800 text-base placeholder-text-base leading-4 py-3 pl-8 w-full  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600 rounded "
            />
            <svg
