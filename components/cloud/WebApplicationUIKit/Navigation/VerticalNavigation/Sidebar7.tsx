...
export default function Sidebar7() {
  ...
  // console.log("Sidebar7 config", config);
  // console.log("Sidebar7 readyDatasrc", readyDatasrc);
  // console.log("Sidebar7 widgetnemgooReady", widgetnemgooReady);
  // console.log("Sidebar7 positionConfig", positionConfig);
