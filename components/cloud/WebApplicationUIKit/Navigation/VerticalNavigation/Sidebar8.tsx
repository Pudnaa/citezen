...
export default function Sidebar8() {
  ...
  // console.log("Sidebar8 config", config);
  // console.log("Sidebar8 readyDatasrc", readyDatasrc);
  // console.log("Sidebar8 widgetnemgooReady", widgetnemgooReady);
  // console.log("Sidebar8 positionConfig", positionConfig);
        ...
        <div className="flex pl-8 justify-start items-center space-x-6">
          <div className="cursor-pointer my-5 rounded-full relative shadow-sm ">
            <input
              ...
              name="toggle"
              id="toggle1"
              className="bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2  checkbox w-4 h-4 rounded-full absolute  shadow-sm appearance-none cursor-pointer"
            />
            <label
              htmlFor="toggle1"
