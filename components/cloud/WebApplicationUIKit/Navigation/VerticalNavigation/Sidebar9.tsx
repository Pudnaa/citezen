...
export default function Sidebar9() {
  ...
  // console.log("Sidebar9 config", config);
  // console.log("Sidebar9 readyDatasrc", readyDatasrc);
  // console.log("Sidebar9 widgetnemgooReady", widgetnemgooReady);
  // console.log("Sidebar9 positionConfig", positionConfig);
  ...
  return (
    <div>
      ...
      <div
        ...
        } bg-indigo-700 transform  xl:translate-x-0 shadow xl:rounded-r fixed h-full top-22 sm:z-20  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 flex-col `}
      >
