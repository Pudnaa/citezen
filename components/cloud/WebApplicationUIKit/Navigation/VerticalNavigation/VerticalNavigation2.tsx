...
export default function VerticalNavigation2() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("VerticalNavigation2 config", config);
  // console.log("VerticalNavigation2 readyDatasrc", readyDatasrc);
  // console.log("VerticalNavigation2 widgetnemgooReady", widgetnemgooReady);
  // console.log("VerticalNavigation2 positionConfig", positionConfig);
  return (
    <>
      {/* Desktop navigation */}
