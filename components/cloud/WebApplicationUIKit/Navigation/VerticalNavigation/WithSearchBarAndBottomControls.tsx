...
function WithSearchBarAndBottomControls() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("WithSearchBarAndBottomControls config", config);
  // console.log("WithSearchBarAndBottomControls readyDatasrc", readyDatasrc);
  // console.log("WithSearchBarAndBottomControls widgetnemgooReady", widgetnemgooReady);
  // console.log("WithSearchBarAndBottomControls positionConfig", positionConfig);
  return (
    <div>
...
export default WithSearchBarAndBottomControls;
