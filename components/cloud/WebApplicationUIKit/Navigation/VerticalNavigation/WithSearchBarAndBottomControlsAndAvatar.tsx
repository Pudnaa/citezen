...
function WithSearchBarAndBottomControlsAndAvatar() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("WithSearchBarAndBottomControlsAndAvatar config", config);
  // console.log("WithSearchBarAndBottomControlsAndAvatar readyDatasrc", readyDatasrc);
  // console.log("WithSearchBarAndBottomControlsAndAvatar widgetnemgooReady", widgetnemgooReady);
  // console.log("WithSearchBarAndBottomControlsAndAvatar positionConfig", positionConfig);
  return (
    <div>
      ...
      <div
        className="w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out"
        id="mobile-nav"
      >
        <div
          className="h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
          id="mobile-toggler"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
...
export default WithSearchBarAndBottomControlsAndAvatar;
