...
const Index = () => {
  ...
  // console.log("AdvanceTableWithFilters,Actions,Search,SortAndExpandedRow config", config);
  // console.log("AdvanceTableWithFilters,Actions,Search,SortAndExpandedRow readyDatasrc", readyDatasrc);
  // console.log("AdvanceTableWithFilters,Actions,Search,SortAndExpandedRow widgetnemgooReady", widgetnemgooReady);
  // console.log("AdvanceTableWithFilters,Actions,Search,SortAndExpandedRow positionConfig", positionConfig);
          ...
          >
              ...
              <tr className="w-full bg-gray-100 border-b border-gray-300 dark:border-gray-200">
                ...
                >
                  <div className="flex items-center justify-between relative chuss-div">
                    ...
                    {dropdownStatus == 8 && (
                      <ul className="bg-white dark:bg-gray-800 shadow rounded mt-2 py-1 w-48 absolute top-0 right-0  dropdown-content">
            ...
            <tbody>
              <tr className="border-b border-gray-300 dark:border-gray-200">
                <td className="pl-3 w-24 py-3">
                  <div className="flex items-center">
                    ...
                    <a
                      ...
                      className=" focus:outline-none cursor-pointer text-gray-800 dark:text-gray-100 ml-2 lg:ml-4 mr-2 sm:mr-0 border border-transparent rounded "
                      href="javascript: void(0)"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <td className="pl-4 pr-4 whitespace-no-wrap w-32">
                  <div className="relative">
                    <div
                      className="relative z-0 text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 flex items-center justify-between border rounded border-gray-300 dark:border-gray-200 w-full cursor-pointer text-xs form-select  py-2 px-2 xl:px-3 dark:border-gray-200 bg-transparent"
                      onClick={() => {
                        dropdownStatus == 0
                    ...
                    >
                      <p className="leading-3 tracking-normal font-normal">
                        Edit Project
                      </p>
                    ...
                    {dropdownStatus == 15 && (
                      <ul className="z-10 bg-white dark:bg-gray-800 transition duration-300 dark:bg-gray-800 shadow rounded mt-2 w-48 py-1 absolute">
              ...
              <tr className="border-b border-gray-300 dark:border-gray-200">
                ...
                <td className="pl-4 pr-4 whitespace-no-wrap w-32">
                  <div className="relative">
                    <div
                      className="relative z-0 text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 flex items-center justify-between border rounded border-gray-300 dark:border-gray-200 w-full cursor-pointer text-xs form-select  py-2 px-2 xl:px-3 dark:border-gray-200bg-transparent"
                      onClick={() => {
                        dropdownStatus == 0
