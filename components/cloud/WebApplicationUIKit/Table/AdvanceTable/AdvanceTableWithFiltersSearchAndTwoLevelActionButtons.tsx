...
export default function AdvanceTableWithFiltersSearchAndTwoLevelActionButtons() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("AdvanceTableWithFiltersSearchAndTwoLevelActionButtons config", config);
  // console.log("AdvanceTableWithFiltersSearchAndTwoLevelActionButtons readyDatasrc", readyDatasrc);
  // console.log("AdvanceTableWithFiltersSearchAndTwoLevelActionButtons widgetnemgooReady", widgetnemgooReady);
  // console.log("AdvanceTableWithFiltersSearchAndTwoLevelActionButtons positionConfig", positionConfig);
  return (
    <>
      <div className="py-12">
          ...
          <div className="flex flex-col lg:flex-row p-8 justify-between items-start lg:items-stretch w-full">
            ...
            <div className="w-full lg:w-3/4 xl:w-2/3 flex flex-col lg:flex-row items-start lg:items-center justify-between">
              ...
              <div className="relative w-full lg:w-1/4 my-2 lg:my-0 cursor-pointer lg:mx-2 xl:mx-4 z-0 border focus:border-gray-800 border-gray-300 dark:border-gray-200 rounded p-2">
                <div className="z-0 w-10 px-2 absolute inset-0 m-auto  border-l mr-0 flex items-center text-indigo-700">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <input
                    type="date"
                    className="absolute right-0 z-10 opacity-0 cursor-pointer"
                  />
                </div>
            ...
            <table className="min-w-full bg-white dark:bg-gray-800 rounded">
              ...
              <tbody>
                ...
                <tr className="h-24 border-gray-300 border-b border-t hover:border-indigo-300 hover:shadow-md cursor-pointer transition duration-150 ease-in-out">
                  ...
                  <td className="pr-6">
                    <div className="w-full flex justify-start items-center h-full">
                      <div className="bg-yellow-200 text-yellow-600 rounded-full text-sm leading-3 py-2 px-5">
                        Reg.
                      </div>
                    </div>
                  </td>
                ...
                <tr className="opacity-50 h-24 border-gray-300 border-b border-t hover:border-indigo-300 hover:shadow-md cursor-pointer transition duration-150 ease-in-out">
                  ...
                  <td className="pr-8 text-right">
                    <button className="cursor-not-allowed bg-gray-200 transition duration-150 ease-in-out rounded text-gray-600 dark:text-gray-400 px-5 py-1 text-sm focus:outline-none">
                      Cancelled
                    </button>
                  </td>
                </tr>
