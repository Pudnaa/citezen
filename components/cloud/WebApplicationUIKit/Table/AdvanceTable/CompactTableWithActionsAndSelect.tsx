...
const CompactTableWithActionsAndSelect = () => {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("CompactTableWithActionsAndSelect config", config);
  // console.log("CompactTableWithActionsAndSelect readyDatasrc", readyDatasrc);
  // console.log("CompactTableWithActionsAndSelect widgetnemgooReady", widgetnemgooReady);
  // console.log("CompactTableWithActionsAndSelect positionConfig", positionConfig);
  return (
    <div className="py-20">
...
export default CompactTableWithActionsAndSelect;
