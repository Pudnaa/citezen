...
function Table() {
  ...
  // console.log("Table readyDatasrc", readyDatasrc);
  // console.log("Table widgetnemgooReady", widgetnemgooReady);
  // console.log("Table positionConfig", positionConfig);
  return (
    <>
                ...
                <tr className="h-20 text-sm leading-none text-gray-800">
                  ...
                  <td className="px-10 lg:px-6 xl:px-0">
                    <div className="flex items-center justify-center w-20 h-6 bg-red-100 rounded-full">
                      <p className="text-xs leading-3 text-red-600">
                        Cancelled
                      </p>
                    </div>
                  </td>
