...
function Table2() {
  ...
  // console.log("Table2 config", config);
  // console.log("Table2 readyDatasrc", readyDatasrc);
  // console.log("Table2 widgetnemgooReady", widgetnemgooReady);
  // console.log("Table2 positionConfig", positionConfig);
  return (
    <>
        ...
        <div className="mb-5 sm:mb-10 rounded-tl-lg rounded-tr-lg">
          <div className="sm:flex items-center justify-between">
            ...
            <div className="flex items-center mt-4 sm:mt-0">
              ...
              <button className="inline-flex ml-3 whitespace-nowrap items-start justify-start px-6 py-3 bg-indigo-700 hover:bg-indigo-600 focus:outline-none rounded">
