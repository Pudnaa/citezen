...
function Tasks() {
  ...
  // console.log("Tasks config", config);
  // console.log("Tasks readyDatasrc", readyDatasrc);
  // console.log("Tasks widgetnemgooReady", widgetnemgooReady);
  // console.log("Tasks positionConfig", positionConfig);
  return (
    <>
      <div>
              ...
              <table className="w-full whitespace-nowrap">
                <tbody>
                  <tr className="h-16 border border-gray-100 rounded">
                    <td>
                      <div className="ml-5">
                        <div className="bg-gray-200 rounded-sm w-5 h-5 flex shrink-0 justify-center items-center relative">
                          <input
                            type="checkbox"
