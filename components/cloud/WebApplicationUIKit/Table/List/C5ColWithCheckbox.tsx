...
export default function C5ColWithCheckbox() {
  const {
    config,
    readyDatasrc,
    positionConfig,
  ...
  // console.log("C5ColWithCheckbox config", config);
  // console.log("C5ColWithCheckbox readyDatasrc", readyDatasrc);
  // console.log("C5ColWithCheckbox widgetnemgooReady", widgetnemgooReady);
  // console.log("C5ColWithCheckbox positionConfig", positionConfig);
            ...
            <thead>
              <tr className="w-full h-16 bg-gray-800 dark:bg-gray-200 py-8">
                ...
                <th className="text-gray-300 dark:text-gray-700 font-normal pr-6 text-left tracking-normal leading-4">
                  <div
                    className="bg-gray-800 dark:bg-gray-200 border rounded-sm border-gray-300 dark:border-gray-700 w-5 h-5 flex shrink-0 justify-center items-center relative"
                    onClick={() => checkAll()}
                  >
                    <input
                      type="checkbox"
            ...
            <tbody>
              <tr className="h-20 border-gray-300 dark:border-gray-700 border-b">
                ...
                <td className="pr-6 text-left whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4">
                  <div className="bg-white dark:bg-gray-800 border rounded-sm border-gray-400 w-5 h-5 flex shrink-0 justify-center items-center relative">
                    <input
                      type="checkbox"
                      className="checkbox opacity-0 absolute cursor-pointer w-full h-full"
                    />
