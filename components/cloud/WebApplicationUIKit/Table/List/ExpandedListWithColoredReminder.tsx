...
export default function ExpandedListWithColoredReminder() {
  const {
    config,
    readyDatasrc,
    widgetnemgooReady,
  ...
  if (isEmpty(readyDatasrc)) return 0;
  // console.log("ExpandedListWithColoredReminder config", config);
  // console.log("ExpandedListWithColoredReminder readyDatasrc", readyDatasrc);
  // console.log("ExpandedListWithColoredReminder widgetnemgooReady", widgetnemgooReady);
  // console.log("ExpandedListWithColoredReminder positionConfig", positionConfig);
  return (
    <>
            ...
            <ul className="pt-6">
              <li className="md:flex justify-between items-center">
                <div className="flex items-center text-gray-400 w-full md:w-1/2">
                  ...
                  <div className="mx-4 bg-white border rounded-sm border-gray-400 w-4 h-4 flex shrink-0 justify-center items-center relative">
                    <input
                      type="checkbox"
                ...
                <div className="md:flex items-center md:w-1/2 w-full justify-end text-gray-700">
                  <p className="text-red-500  mt-4 md:mt-0 mr-10">
                    Due today at 18:00
                  </p>
          ...
          {show == 1 && (
            <ul className="pt-6">
              <li className="md:flex justify-between items-center">
                ...
                <div className="md:flex items-center md:w-1/2 w-full justify-end text-gray-700">
                  <p className="text-yellow-600  mt-4 md:mt-0 mr-10">
                    Due today at 18:00
                  </p>
                  <div className="mt-4 md:mt-0 flex items-center">
                    <div className="mr-3">
