...
export default function FilesListWithIcons() {
  const {
    config,
    readyDatasrc,
    widgetnemgooReady,
  ...
  // console.log("FilesListWithIcons config", config);
  // console.log("FilesListWithIcons readyDatasrc", readyDatasrc);
  // console.log("FilesListWithIcons widgetnemgooReady", widgetnemgooReady);
  // console.log("FilesListWithIcons positionConfig", positionConfig);
  return (
    <>
