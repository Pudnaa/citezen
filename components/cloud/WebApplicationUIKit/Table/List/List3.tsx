...
function List3() {
  ...
  // console.log("List3 config", config);
  // console.log("List3 readyDatasrc", readyDatasrc);
  // console.log("List3 widgetnemgooReady", widgetnemgooReady);
  // console.log("List3 positionConfig", positionConfig);
  return (
    <>
