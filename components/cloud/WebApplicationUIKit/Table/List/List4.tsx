...
function List4() {
  ...
  // console.log("List4 config", config);
  // console.log("List4 readyDatasrc", readyDatasrc);
  // console.log("List4 widgetnemgooReady", widgetnemgooReady);
  // console.log("List4 positionConfig", positionConfig);
