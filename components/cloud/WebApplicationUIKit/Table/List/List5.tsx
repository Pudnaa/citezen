...
function List5() {
  ...
  // console.log("List5 config", config);
  // console.log("List5 readyDatasrc", readyDatasrc);
  // console.log("List5 widgetnemgooReady", widgetnemgooReady);
  // console.log("List5 positionConfig", positionConfig);
  return (
    <>
