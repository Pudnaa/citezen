...
function List6() {
  ...
  // console.log("List6 config", config);
  // console.log("List6 readyDatasrc", readyDatasrc);
  // console.log("List6 widgetnemgooReady", widgetnemgooReady);
  // console.log("List6 positionConfig", positionConfig);
  return (
    <>
      <div className="lg:pr-6 lg:w-5/12 w-full px-4">
        <div className="border rounded-lg  pb-8 border-gray-200">
            ...
            <div>
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <p className="text-xs md:text-sm leading-none text-blue-500 pl-3">
                    (CID 879-10-940)
                  </p>
                </div>
                <div>
              ...
              <div className="py-2">
                <p className="text-xs md:text-sm leading-tight text-gray-600">
                  Order has not been received and is past the delivery...
                </p>
              </div>
              <div>
                <p className="text-sm leading-none underline text-indigo-700 cursor-pointer">
                  Resolve
                </p>
              </div>
            </div>
