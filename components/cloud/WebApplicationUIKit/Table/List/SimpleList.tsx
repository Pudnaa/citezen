...
const SimpleList = () => {
  ...
  // console.log("SimpleList config", config);
  // console.log("SimpleList readyDatasrc", readyDatasrc);
  // console.log("SimpleList widgetnemgooReady", widgetnemgooReady);
  // console.log("SimpleList positionConfig", positionConfig);
  return (
    <div>
      <div className="container mx-auto px-6 py-10">
        <div className="sm:shadow rounded bg-white dark:bg-gray-800">
          <div className="xl:w-full w-11/12 mx-auto flex flex-wrap items-center justify-between px-8 mb-2 xl:mb-0 lg:mb-0 border-b border-gray-300 dark:border-gray-700">
          ...
          <div className="xl:w-full w-11/12 mx-auto flex flex-wrap items-center justify-between px-8 mb-2 xl:mb-0 lg:mb-0">
            <div className="xl:w-1/5 py-5">
              <div className="flex items-center">
                <div className="w-12 h-12 rounded">
                  <img
