...
const Rows: FC<PropsType> = ({ pathConfig, config }) => {
	...
	return (
		<div
			...
			} w-full overflow-y-auto newRows  scrollbar-thumb-citizen scrollbar-track-gray-200 scrollbar-thin hover:scrollbar-thumb-citizen-dark scrollbar-thumb-rounded-full`}
		>
