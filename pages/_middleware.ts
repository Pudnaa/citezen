...
export default function middleware(req: NextRequest, ev: NextFetchEvent) {
	...
	// if (hostObject.domain.rootDomain !== "citizen") {
	//   console.log("middleware XXXXX hostname: ", hostname);
	//   console.log("middleware XXXXX pathname: ", pathname);
	...
	if (
		...
		!url.pathname.startsWith("/langGlobImport") && // glob code
		!url.pathname.startsWith("/page") && // page-ийг бас орхих хэрэгтэй.
		!url.pathname.startsWith("/jaak") // jaak-ийг туршилтаар хийж байгаа тул орхих хэрэгтэй.
	) {
		// V1.0
