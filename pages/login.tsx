  ...
  return (
    <>
      <div className="bg-gray-100 w-screen h-screen flex flex-row">
        ...
        <div className="flex-shrink-0 w-full sm:w-96 overflow-y-auto scrollbar scrollbar-thumb-sso scrollbar-track-gray-200 scrollbar-thin hover:scrollbar-thumb-sso-dark scrollbar-thumb-rounded-full">
          <CloudLoginPage />
        </div>
      </div>
    </>
